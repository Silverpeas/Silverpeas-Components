...
public class TestMessageService {
  ...
  public DbUnitLoadingRule dbUnitLoadingRule =
      new DbUnitLoadingRule("create-database.sql", "test-message-service-dataset.xml");

  @Deployment
  public static Archive<?> createTestArchive() {
    return MailingListWarBuilder.onWarForTestClass(TestMessageService.class).testFocusedOn(
        warBuilder -> {
