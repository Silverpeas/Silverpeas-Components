...
@ContextConfiguration(locations = {"/spring-checker.xml", "/spring-notification.xml",
  "/spring-hibernate.xml", "/spring-silverpeas.xml", "/spring-personalization.xml",
  "/spring-datasource.xml"})
public class TestActivitiesProcessor extends AbstractSilverpeasDatasourceSpringContextTests {
  ...
  protected IDataSet getDataSet() throws Exception {
    ...
    if (isOracle()) {
      dataSet = new ReplacementDataSet(new FlatXmlDataSet(
          TestActivitiesProcessor.class.getResourceAsStream(
          "test-mailinglist-messages-oracle-dataset.xml")));
    } else {
