...
public class ScheduleEventBackwardRequestHandler implements ScheduleEventRequestHandler {
  ...
  private ScheduleEventBackableRequestHandler backRequestHandler;
  ...
  public void setBackRequestHandler(
      ScheduleEventBackableRequestHandler backRequestHandler) {
      this.backRequestHandler = backRequestHandler;
  }
