	...
	implements ComponentsInstanciatorIntf
{
		...
		throws InstanciationException
	{
		SilverTrace.info("myDB", "MyDBInstanciator.create()",
			"root.MSG_GEN_ENTER_METHOD", "space=" + spaceId + ", componentId=" + componentId + ", userId=" + userId);
		
		SilverTrace.info("myDB", "MyDBInstanciator.create()", "root.MSG_GEN_EXIT_METHOD");
	}
		...
		throws InstanciationException
	{
		...
		SilverTrace.info("myDB", "MyDBInstanciator.delete()", "root.MSG_GEN_EXIT_METHOD");
	}
