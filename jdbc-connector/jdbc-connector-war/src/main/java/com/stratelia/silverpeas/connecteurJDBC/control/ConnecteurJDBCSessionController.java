...
public class ConnecteurJDBCSessionController extends AbstractComponentSessionController
{
	...
	private Vector selectedColumn = new Vector(); // the columns selected in the SQL request

	/**
	 * Constructeur
	 *
	 */
	public ConnecteurJDBCSessionController(MainSessionController mainSessionCtrl, ComponentContext componentContext)
		throws ConnecteurJDBCRuntimeException
	{
		super(mainSessionCtrl, componentContext, "com.stratelia.silverpeas.connecteurJDBC.multilang.connecteurJDBC");
		loadDrivers();
		initConnecteur();
	}
	...
	private ConnecteurJDBCBm getConnecteurJDBCBm() throws ConnecteurJDBCException
	{
		if ((this.connecteurJDBCEjb == null))
		{
			try
			{
				ConnecteurJDBCBmHome connecteurJDBCEjbHome =
					(ConnecteurJDBCBmHome) EJBUtilitaire.getEJBObjectRef(JNDINames.CONNECTEURJDBC_EJBHOME, ConnecteurJDBCBmHome.class);
			...
			catch (Exception e)
			{
				throw new ConnecteurJDBCException(
					...
					"connecteurJDBC.EX_EJB_CREATION_FAIL",
					e);
			}
		}
		...
		if (this.searchEngineEjb == null)
		{
			...
			catch (Exception e)
			{
				throw new ConnecteurJDBCException(
					...
					SilverpeasException.ERROR,
					"connecteurJDBC.EX_CANT_GET_SEARCHENGINE",
					e);
			}
		}
	...
	private void initConnecteur() throws ConnecteurJDBCRuntimeException
	{
		if (connecteurJDBCDetail == null)
			try
			{
				...
				Collection c = connecteurJDBCBm.getConnectionList(new ConnecteurJDBCConnectionInfoPK("", getSpaceId(), getComponentId()));
				if (c.size() > 1)
					throw new ConnecteurJDBCRuntimeException("connecteurJDBCSessionControl.initConnecteur()", SilverpeasException.FATAL, "connecteurJDBC.EX_THERE_MUST_BE_ONLY_ONE_CONECTION");
			...
			{
				throw new ConnecteurJDBCRuntimeException("connecteurJDBCSessionControl.initConnecteur()", SilverpeasException.FATAL, "connecteurJDBC.EX_INIT_CONNECTEUR_FAIL", e);
			}
	}
		...
		if (connectionOpened)
			...
			catch (SQLException e)
			{
				SilverTrace.warn(
					...
					"connecteurJDBC.MSG_CONNECTION_NOT_CLOSED",
					null,
					e);
	...
	public void startConnection()
	{
		...
		SilverTrace.info("connecteurJDBC", "ConnecteurJDBCSessionController.startConnection()", "root.MSG_GEN_ENTER_METHOD", "temp : " + temp);
		rowNumber = 0;
		...
		if (!connectionOpened && (connecteurJDBCDetail != null))
		{
			...
			catch (SQLException e)
			{
				SilverTrace.warn(
					...
					"connecteurJDBC.MSG_CONNECTION_NOT_STARTED",
					"request : " + getSQLreq(),
					e);
			}
		}
	...
	{
		SilverTrace.info("connecteurJDBC", "ConnecteurJDBCSessionController.setValidRequest()", "root.MSG_GEN_ENTER_METHOD", "validreq : " + validreq);
	...
	{
		SilverTrace.info("connecteurJDBC", "ConnecteurJDBCSessionController.setFullRequest()", "root.MSG_GEN_ENTER_METHOD", "fullreq : " + fullreq);
	...
	public String[] getTableNames() throws ConnecteurJDBCException
	{
		...
		catch (Exception e)
		{
			throw new ConnecteurJDBCException(
				...
				SilverpeasException.ERROR,
				"connecteurJDBC.EX_CANT_GET_TABLES_NAMES",
				e);
		}
		closeConnection();
		return tableNames;
	...
	private ResultSet getTable(String tableName) throws ConnecteurJDBCException
	{
		...
		{
			throw new ConnecteurJDBCException(
				"connecteurJDBCSessionControl.getTable()",
				SilverpeasException.ERROR,
				"connecteurJDBC.EX_GET_TABLE_FAIL",
	...
	public String[] getColumnNames(String tableName) throws ConnecteurJDBCException
	{
		...
		catch (SQLException e)
		{
			throw new ConnecteurJDBCException(
				"connecteurJDBCSessionControl.getTable()",
				SilverpeasException.ERROR,
				"connecteurJDBC.EX_GET_COLUMNS_NAMES_FAIL",
				"from table : " + tableName,
				e);
		}
	...
	/**
	 * get the column selected to restrict the request results
	 * in the page connecteurJDBC.jsp
	 */
	...
	/**
	 * get the value with wich a column is compared
	 * to restrict the sql request results
	 */
		...
		if (rs != null)
			...
			catch (SQLException e)
			{
				SilverTrace.warn(
					...
					"connecteurJDBC.MSG_CANT_GET_Column_Count",
					null,
					e);
			}
		return ret;
		...
		if (rs != null)
			...
			catch (SQLException e)
			{
				SilverTrace.warn(
					...
					"connecteurJDBC.MSG_CANT_GET_COLUMN_NAME",
					"column number : " + i,
					e);
			}
		return ret;
		...
		if (rs != null)
			...
			catch (SQLException e)
			{
				SilverTrace.warn(
					...
					"connecteurJDBC.MSG_CANT_GET_COLUMN_TYPE",
					"column number : " + i,
					e);
			}
		return ret;
			...
			if (getRowLimit()==0 || rowNumber < getRowLimit())
			{
				...
				catch (SQLException e)
				{
					SilverTrace.warn(
						...
						"connecteurJDBC.MSG_CANT_GET_NEXT_ROW",
						null,
						e);
				}
			}
		...
		if (rs != null)
			...
			catch (SQLException e)
			{
				SilverTrace.warn(
					...
					"connecteurJDBC.MSG_CANT_GET_COLUMN_VALUE",
					null,
					e);
			}
		return ret;
	...
	public void setJDBCdriverName(String JDBCdriverName) throws ConnecteurJDBCException
	{
		...
		if (connecteurJDBCDetail == null)
		{
			...
			connecteurJDBCDetail.setPK(new ConnecteurJDBCConnectionInfoPK("", getSpaceId(), getComponentId()));
			newConnecteur();
		}
	...
	private int searchDriverIndice(String driverName)
	{
		SilverTrace.info(
			...
			"connecteurJDBC.MSG_DRIVER_NAME",
	...
	{
		SilverTrace.info("connecteurJDBC", "ConnecteurJDBCSessionControl.registerAndInstanciateDriver()", "root.MSG_GEN_ENTER_METHOD", "driverName="+driverName);
		SilverTrace.info("connecteurJDBC", "ConnecteurJDBCSessionControl.registerAndInstanciateDriver()", "root.MSG_GEN_PARAM_VALUE", "driversClassNames.length="+driversClassNames.length);
	...
	public void loadDrivers()
	{
		try
		{
			...
			m_ConfigFileInputStream = ResourceLocator.getResourceAsStream(this, null, configFileStr, ".xml");
			XMLConfigurationStore m_XMLConfig = new XMLConfigurationStore(null, m_ConfigFileInputStream, "ConnecteurJDBC-configuration");
			...
			for (int j = 0; j < driversNames.length; j++)
			{
				SilverTrace.info(
					...
					"connecteurJDBC.MSG_DRIVER_NAME",
					"DriverName=" + driversNames[j]);

				m_ConfigFileInputStream = ResourceLocator.getResourceAsStream(this, null, configFileStr, ".xml");
				m_XMLConfig = new XMLConfigurationStore(null, m_ConfigFileInputStream, driversNames[j] + "-configuration");
		...
		catch (Exception e)
		{
			SilverTrace.warn(
				"connecteurJDBC",
				"ConnecteurJDBCSessionControl.loadDrivers()",
				"connecteurJDBC.MSG_load_DRIVERS_FAIL",
				null,
				e);
		}
	}
	...
	{
		String[] str = (String[]) driversUrls.elementAt(searchDriverIndice(driverName));
		...
		if (connecteurJDBCDetail != null)
			...
			catch (Exception e)
			{
				throw new ConnecteurJDBCException(
					...
					"connecteurJDBC.EX_UPDATE_CONNECTION_FAIL",
					null,
					e);
			}
	}
		...
		if (connecteurJDBCDetail != null)
			...
			catch (Exception e)
			{
				throw new ConnecteurJDBCException(
					...
					SilverpeasException.FATAL,
					"connecteurJDBC.EX_NEW_CONNECTION_FAIL",
					null,
					e);
			}
	}
	...
	private Driver getDriver()
	{
		if (driver == null)
		{
			try
			{
				...
				{
					SilverTrace.info("connecteurJDBC", "ConnecteurJDBCSessionControl.getDriver()", "root.MSG_GEN_PARAM_VALUE", "driverName undefined ! default one used instead = "+driverName);
			...
			{
				SilverTrace.warn("connecteurJDBC", "ConnecteurJDBCSessionControl.initConnecteur()",	"connecteurJDBC.MSG_INIT_CONNECTEUR_FAIL", null, e);
			}
		}
		return driver;
	}
	...
	public String checkConnection(String JDBCurl, String login, String password)
	{
		...
		else
		{
			...
			{
				SilverTrace.warn("connecteurJDBC", "ConnecteurJDBCSessionControl.checkConnection()", "connecteurJDBC.MSG_CHECK_CONNECTION_FAIL", "login : " + login + "password : " + password + "JDBCurl : " + JDBCurl, e);
				return (SilverTrace.getTraceMessage("connecteurJDBC.MSG_CHECK_CONNECTION_FAIL", getLanguage()));
			}
			finally
			{
				if (con != null)
	...
	{
		SilverTrace.info("connecteurJDBC", "ConnecteurJDBCSessionController.checkRequest()", "root.MSG_GEN_ENTER_METHOD", "request : " + request);
				...
				if ((request == null) || (request.trim().equals("")))
				{
					...
					else
					{
						...
						if (con == null) {
							...
							// il fallait cliquer deux fois sur consultation c'est pourquoi ce commentaire!!!!!
							/*if (rs!=null)
								rs.close();*/
						}
					}
		...
		catch (SQLException e)
		{
			SilverTrace.warn(
				...
				"connecteurJDBC.MSG_CHECK_REQUEST_FAIL",
				"request : " + request,
				e);
			return (e.getMessage());
		}
		catch (MissingResourceException e)
		{
			SilverTrace.warn(
				"connecteurJDBC",
				"ConnecteurJDBCSessionControl.checkConnection()",
				"connecteurJDBC.MSG_MISSING_MESSAGE_ERROR",
				"request : " + request,
				e);
	...
	public void close()
	{
		...
		{
			SilverTrace.error("connecteurJDBCSession", "ConnecteurJDBCSessionController.close", "", e);
		}
