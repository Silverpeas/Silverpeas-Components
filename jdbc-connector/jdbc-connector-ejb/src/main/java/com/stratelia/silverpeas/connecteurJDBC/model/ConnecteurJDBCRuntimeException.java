...
public class ConnecteurJDBCRuntimeException extends SilverpeasRuntimeException {
  ...
  public ConnecteurJDBCRuntimeException(String callingClass, int errorLevel, String message, String extraParams) {
	super(callingClass, errorLevel, message, extraParams);
  }

  public ConnecteurJDBCRuntimeException(String callingClass, int errorLevel, String message, Exception nested) {
