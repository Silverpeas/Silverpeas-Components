  ...
  <script language="javascript">
    ...
    function clipboardCopy() {
      top.IdleFrame.location.href =
          '../..<%=gallerySC.getComponentUrl()%>copy?Object=Image&Id=<%=media.getId()%>';
    }

    function clipboardCut() {
      top.IdleFrame.location.href =
          '../..<%=gallerySC.getComponentUrl()%>cut?Object=Image&Id=<%=media.getId()%>';
    }
        ...
        <div class="fileName">
          <c:choose>
            <c:when test="${requestScope.ViewLinkDownload or video.downloadable}">
              <a href="${mediaUrl}" target="_blank">${video.name}
                <img src="${downloadIconUrl}" alt="<fmt:message key='gallery.download.photo'/>" title="<fmt:message key='gallery.originale'/>"/></a>
            </c:when>
            <c:otherwise>
              ${video.fileName}
        ...
        <div class="bgDegradeGris" id="suggestionInfoPublication">
          ...
          <c:if test="${not empty video.lastUpdater}">
            <div class="paragraphe" id="infoModification">
              ...
              <div class="profilPhoto">
                <img src='<c:url value="${video.lastUpdater.avatar}" />' alt="" class="defaultAvatar"/>
              </div>
            </div>
          </c:if>
          ...
          <c:if test="${not empty video.creator}">
            <div class="paragraphe" id="infoCreation">
              ...
              <div class="profilPhoto">
                <img src='<c:url value="${video.creator.avatar}" />' alt="" class="defaultAvatar"/>
              </div>
            </div>
          </c:if>
          <p id="permalinkInfo">
