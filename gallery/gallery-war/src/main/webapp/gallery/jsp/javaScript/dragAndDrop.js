...
var dNdLoaded	= false;
function showHideDragDrop(targetURL1, message1, properties, max_upload, pathJreInstaller, expandLabel, collapseLabel)
{
...
function loadApplet(divId, targetURL, message, properties, max_upload, pathJreInstaller)
{
	...
	addParam(objectDND, "message", message);
   	addParam(objectDND, "monitor.type", "thumbnails");
