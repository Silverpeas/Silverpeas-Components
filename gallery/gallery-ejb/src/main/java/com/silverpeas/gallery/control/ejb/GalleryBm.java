...
{
	// les albums ...
	public AlbumDetail getAlbum(NodePK nodePK,boolean viewAllPhoto) throws RemoteException;
	public NodePK createAlbum(AlbumDetail album, NodePK nodePK) throws RemoteException;
	...
	public void setPhotoPath(String photoId, String[] albums, String instanceId) throws RemoteException;
	public void updatePhotoPath(String photoId, String[] albums, String instanceIdFrom, String instanceIdTo) throws RemoteException;
	
	// les photos ...
	public PhotoDetail getPhoto(PhotoPK photoPK) throws RemoteException;
	public Collection getAllPhoto(NodePK nodePK, boolean viewAllPhoto) throws RemoteException;
	public Collection getAllPhotos(String instanceId) throws RemoteException;
	public String createPhoto(PhotoDetail photo, String albumId) throws RemoteException;
	...
	public Collection getDernieres(String instanceId, boolean viewAllPhoto) throws RemoteException;
	public Collection getAllPhotoEndVisible(int nbDays) throws RemoteException;
	public void notifyUsers(NotificationMetaData notifMetaData, String senderId, String instanceId)  throws RemoteException;
	...
	public Collection getPathList(String instanceId, String photoId) throws RemoteException;
	...
	// les demandes
	public String createOrder(Collection basket, String userId, String instanceId) throws RemoteException;
	public Order getOrder(String orderId, String instanceId) throws RemoteException;
	public List getAllOrders(String userId, String instanceId) throws RemoteException;
