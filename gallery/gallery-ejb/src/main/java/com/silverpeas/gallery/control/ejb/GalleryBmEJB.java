...
public class GalleryBmEJB implements SessionBean
{
	...
	public AlbumDetail getAlbum(NodePK nodePK, boolean viewAllPhoto)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getAlbum()", SilverpeasRuntimeException.ERROR, "gallery.MSG_ALBUM_NOT_EXIST", e);
		}
	}
	...
	public Collection getAllAlbums(String instanceId)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getAllAlbum()", SilverpeasRuntimeException.ERROR, "gallery.MSG_ALBUM_NOT_EXIST", e);
		}
	}
	...
	public NodePK createAlbum(AlbumDetail album, NodePK nodePK)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.createAlbum()", SilverpeasRuntimeException.ERROR, "gallery.MSG_ALBUM_NOT_CREATE", e);
		}
	}
	...
	public void updateAlbum(AlbumDetail album)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.updateAlbum()", SilverpeasRuntimeException.ERROR, "gallery.MSG_ALBUM_NOT_UPDATE", e);
		}
	}
	...
	public void deleteAlbum(NodePK nodePK)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.deleteAlbum()", SilverpeasRuntimeException.ERROR, "gallery.MSG_ALBUM_NOT_DELETE", e);
		}
	}
	...
	private NodeBm getNodeBm()
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getNodeBM()", SilverpeasRuntimeException.ERROR, "root.EX_RECORD_NOT_FOUND", e);
		}
		return nodeBm;
	}
	...
	public PhotoDetail getPhoto(PhotoPK photoPK)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getPhoto()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public Collection getAllPhotos(String instanceId)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getAllPhotos()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public Collection getAllPhoto(NodePK nodePK, boolean viewAllPhoto)
	{
		...
		try
		{
			...
			Collection photos = PhotoDAO.getAllPhoto(con, albumId, instanceId, viewAllPhoto);

			return photos;
		}
		catch (Exception e)
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getAllPhoto()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public Collection getNotVisible(String instanceId)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getNotVisible()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public String createPhoto(PhotoDetail photo, String albumId)
	{
		...
		try
		{
			...
			ResourceLocator metadataSettings = new ResourceLocator("com.silverpeas.gallery.settings.metadataSettings", "fr");
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.createPhoto()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_CREATE", e);
		}
		finally
		{
			// fermer la connexion
	...
	public void updatePhoto(PhotoDetail photo)
	{
		...
		try
		{
			SilverTrace.info("gallery", "GalleryBmEJB.updatePhoto()", "root.MSG_GEN_ENTER_METHOD", "PhotoPK = " + photo.toString());
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.updatePhoto()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_UPDATE", e);
		}
		finally
		{
			// fermer la connexion
	...
	public void deletePhoto(PhotoPK photoPK)
	{
		...
		try
		{
			...
			String nomRep = gallerySettings.getString("imagesSubDirectory") + photoPK.getId();
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.deletePhoto()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_DELETE", e);
		}
		finally
		{
			// fermer la connexion
	...
	private void fermerCon(Connection con)
	{
		...
		catch (SQLException e)
		{
			...
			throw new GalleryRuntimeException("GalleryBmEJB.fermerCon()", SilverpeasException.ERROR, "root.EX_CONNECTION_CLOSE_FAILED", e);
		}
	}
	...
	private Connection initCon()
	{
		...
		{
			// traitement des exceptions
			throw new GalleryRuntimeException("GalleryBmEJB.initCon()", SilverpeasException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
		}
		return con;
	}
	...
	public Collection getPath(NodePK nodePK)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getPath()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PATH", e);
		}
		return path;
	}
	...
	public Collection getPathList(String instanceId, String photoId)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getPathList()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PATH", e);
		}
		finally
		{
			// fermer la connexion
	...
	public void setPhotoPath(String photoId, String[] albums, String instanceId)
	{
		...
		try
		{
			SilverTrace.debug("gallery", "GalleryBmEJB.setPhotoPath()", "root.MSG_GEN_PARAM_VALUE", "photoId = " + photoId);
			PhotoDAO.deletePhotoPath(con, photoId, instanceId);
			for (int i = 0; i < albums.length; i++)
			{
				String albumId = albums[i];
				SilverTrace.debug("gallery", "GalleryBmEJB.setPhotoPath()", "root.MSG_GEN_PARAM_VALUE", "albumId = " + albumId);
				PhotoDAO.addPhotoPath(con, photoId, albumId, instanceId);
			}
		}
		catch (Exception e)
		{
			throw new GalleryRuntimeException("GalleryBmEJB.setPhotoPath()", SilverpeasRuntimeException.ERROR, "gallery.IMPOSSIBLE_D_AJOUTER_LES_MODELES", e);
		}
		finally
		{
			// fermer la connexion
	...
	public void updatePhotoPath(String photoId, String[] albums, String instanceIdFrom, String instanceIdTo)
	{
		Connection con = initCon();
		try
		{
			SilverTrace.debug("gallery", "GalleryBmEJB.updatePhotoPath()", "root.MSG_GEN_PARAM_VALUE", "photoId = " + photoId);
			PhotoDAO.deletePhotoPath(con, photoId, instanceIdFrom);
			for (int i = 0; i < albums.length; i++)
			{
				String albumId = albums[i];
				SilverTrace.debug("gallery", "GalleryBmEJB.addAlbumPath()", "root.MSG_GEN_PARAM_VALUE", "albumId = " + albumId);
				PhotoDAO.addPhotoPath(con, photoId, albumId, instanceIdTo);
			}
		}
		catch (Exception e)
		{
			throw new GalleryRuntimeException("GalleryBmEJB.updatePhotoPath()", SilverpeasRuntimeException.ERROR, "gallery.IMPOSSIBLE_D_AJOUTER_LES_MODELES", e);
		}
		finally
		{
			// fermer la connexion
	...
	public String getHTMLNodePath(NodePK nodePK)
	{
		...
		try
		{
			...
			htmlPath = getSpacesPath(nodePK.getInstanceId()) + getComponentLabel(nodePK.getInstanceId()) + " > " + displayPath(path, 10);
		}
		catch (Exception e)
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getHTMLNodePath()", SilverpeasRuntimeException.ERROR, "gallery.EX_IMPOSSIBLE_DOBTENIR_LES_EMPLACEMENTS_DE_LA_PUBLICATION", e);
		}
		return htmlPath;
	}
	...
	public void indexGallery(String instanceId)
	{
		...
		if (albums != null)
		{
			...
			while (it.hasNext())
			{
				...
				{
					throw new GalleryRuntimeException("GalleryBmEJB.indexGallery()", SilverpeasRuntimeException.ERROR, "gallery.MSG_INDEXALBUM", e);
				}
				...
				if (photos != null)
				{
					...
					while (itP.hasNext())
					{
						...
						{
							SilverTrace.info("gallery", "GalleryBmEJB.indexGallery()", "root.MSG_GEN_ENTER_METHOD", "Impossible d'ajouter les métadata à la photo " + photo.toString());
						}
	...
	{
		SilverTrace.info("gallery", "GalleryBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "photoDetail = " + photo.toString());
		FullIndexEntry indexEntry = null;

		if (photo != null)
		{
			// Index the Photo
			indexEntry = new FullIndexEntry(photo.getPhotoPK().getComponentName(), "Photo", photo.getPhotoPK().getId());
			...
			if (photo.getImageName() != null)
			{
				...
				indexEntry.setThumbnailDirectory(gallerySettings.getString("imagesSubDirectory") + photo.getPhotoPK().getId());
			}
			...
			SilverTrace.info("gallery", "GalleryBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "metaData = " + metaDataStr + " indexEntry = " + indexEntry.toString());
			...
			while (it.hasNext())
			{
				...
				metaData = photo.getMetaData(property);
				String value = metaData.getValue();
				SilverTrace.info("gallery", "GalleryBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "property = " + property + " value = " + value);
			...
			String xmlFormName = getOrganizationController().getComponentParameterValue(photo.getInstanceId(), "XMLFormName");
			SilverTrace.info("gallery", "GalleryBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "xmlFormName = " + xmlFormName);
			if (xmlFormName != null && !xmlFormName.equals("") && !xmlFormName.equals("null"))
			{
				String xmlFormShortName = xmlFormName.substring(xmlFormName.indexOf("/")+1, xmlFormName.indexOf("."));
				PublicationTemplate pubTemplate;
				try
				{
					pubTemplate = PublicationTemplateManager.getPublicationTemplate(photo.getInstanceId()+":"+xmlFormShortName);
					RecordSet set = pubTemplate.getRecordSet();
					set.indexRecord(photo.getPhotoPK().getId(), xmlFormShortName, indexEntry);
					SilverTrace.info("gallery", "GalleryBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "indexEntry = " + indexEntry.toString());
				}
				catch (Exception e)
				{
					throw new GalleryRuntimeException("GalleryBmEJB.createIndex()", SilverpeasRuntimeException.ERROR, "gallery.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
				}				
			}
	...
	{
		SilverTrace.info("gallery", "GalleryBmEJB.deleteIndex()", "root.MSG_GEN_ENTER_METHOD", "PhotoPK = " + photoPK.toString());
		IndexEntryPK indexEntry = new IndexEntryPK(photoPK.getComponentName(), "Photo", photoPK.getId());
	...
	{
		SilverTrace.info("gallery", "GalleryBmEJB.getSilverObjectId()", "root.MSG_GEN_ENTER_METHOD", "photoId = " + photoPK.getId());
		int silverObjectId = -1;
		PhotoDetail photoDetail = null;
		try
		{
			silverObjectId = getGalleryContentManager().getSilverObjectId(photoPK.getId(), photoPK.getInstanceId());
			if (silverObjectId == -1)
			{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getSilverObjectId()", SilverpeasRuntimeException.ERROR, "gallery.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
		}
		return silverObjectId;
	}

	private int createSilverContent(Connection con, PhotoDetail photoDetail, String creatorId)
	{
		SilverTrace.info("gallery", "GalleryBmEJB.createSilverContent()", "root.MSG_GEN_ENTER_METHOD", "photoId = " + photoDetail.getPhotoPK().getId());
		try
		{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.createSilverContent()", SilverpeasRuntimeException.ERROR, "gallery.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
		}
	}
	...
	public Collection search(QueryDescription query)
	{
		...
		try
		{
			...
			for (int i = 0; i < result.length; i++)
			{
				...
				if (matchIndex.getObjectType().equals("Photo"))
				{
					...
					if (photo != null)
					{
						SilverTrace.info("gallery", "GalleryBmEJB.getResultSearch()", "root.MSG_GEN_ENTER_METHOD", "photo = " + photo.getPhotoPK().getId());
						photos.add(photo);
					}
				}
			}
		...
		{
			throw new GalleryRuntimeException("GallerySessionController.getResultSearch()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_ADD_OBJECT", e);
		}
		return photos;
	}
	...
	public void notifyUsers(NotificationMetaData notifMetaData, String senderId, String componentId) 
	{
		Connection con = null;
		try 
		{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.notifyUsers()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_EXIST", e);
		} 
		finally 
		{
			fermerCon(con);
	...
	public String createOrder(Collection basket, String userId, String componentId)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.createOrder()", SilverpeasRuntimeException.ERROR, "gallery.MSG_REQUEST_NOT_CREATE", e);
		}
		finally
		{
			// fermer la connexion
	...
	public List getAllOrders(String userId, String instanceId) 
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getAllOrders()", SilverpeasRuntimeException.ERROR, "gallery.MSG_REQUEST_LIST_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public void updateOrder(Order order)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.updateORder()", SilverpeasRuntimeException.ERROR, "gallery.MSG_REQUEST_ORDER_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public void updateOrderRow(OrderRow row)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.updateOrderRow()", SilverpeasRuntimeException.ERROR, "gallery.MSG_REQUEST_ORDER_ROW_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public Order getOrder(String orderId, String instanceId)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.getOrder()", SilverpeasRuntimeException.ERROR, "gallery.MSG_ORDER_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public void deleteOrder(String orderId)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.deleteOrder()", SilverpeasRuntimeException.ERROR, "gallery.MSG_ORDER_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public Date getDownloadDate(String orderId, String photoId)
	{
		...
		{
			throw new GalleryRuntimeException("GalleryBmEJB.photoDateDownload()", SilverpeasRuntimeException.ERROR, "gallery.MSG_PHOTO_NOT_EXIST", e);
		}
		finally
		{
			// fermer la connexion
	...
	public PublicationBm getPublicationBm() 
	{
	      ...
	      try 
	      {
			...
			{
				throw new CommentRuntimeException("GallerySessionController.getPublicationBm()", SilverpeasException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
			}
	...
	public SearchEngineBm getSearchEngineBm()
	{
		SearchEngineBm searchEngineBm = null;
		{
			...
			{
				throw new CommentRuntimeException("GallerySessionController.getSearchEngineBm()", SilverpeasException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
			}
		}
