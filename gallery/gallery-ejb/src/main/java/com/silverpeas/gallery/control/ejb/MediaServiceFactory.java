...
public class MediaServiceFactory {
  ...
  /**
   * @return an instance of {@link GalleryBm} EJB.
   */
  public static GalleryBm getMediaService() {
    if (getInstance().galleryBm == null) {
      try {
        ...
        throw new GalleryRuntimeException("MediaServiceFactory.getMediaService()",
            SilverpeasException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
      }
    }
    return getInstance().galleryBm;
  }
  ...
  public void setMediaService(GalleryBm mediaService) {
    getInstance().galleryBm = mediaService;
  }
}
