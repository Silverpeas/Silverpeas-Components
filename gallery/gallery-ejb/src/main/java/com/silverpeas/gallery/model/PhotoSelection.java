...
public class PhotoSelection extends ClipboardSelection implements Serializable {
  ...
  static {
    try {
      PhotoDetailFlavor = new DataFlavor (Class.forName ("com.silverpeas.gallery.model.PhotoDetail"), "Photo");
  ...
  private InfoDetail m_infoDetail;
	...
	public IndexEntry getIndexEntry () {
	   ...
	   PhotoPK photoPK = m_photo.getPhotoPK();
		indexEntry = new IndexEntry(photoPK.getComponentName(), "Photo", m_photo.getPhotoPK().getId());
