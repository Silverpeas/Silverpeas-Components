...
public class OrderDAO
{
	...
	public static String createOrder(Connection con, Collection basket, String userId, String instanceId) throws SQLException, UtilException
	{
	...
	public static List getAllPhotos(Connection con, String orderId) throws SQLException
	{
		...
		try
		{
			...
			while (rs.next())
			{
				...
				OrderRow orderRow = new OrderRow(Integer.parseInt(orderId), Integer.parseInt(photoId), instanceId);
				String downloadDate = null;
				downloadDate = rs.getString(3);
				try
				{
					if (downloadDate != null)
						orderRow.setDownloadDate(new Date(Long.parseLong((String) downloadDate)));
				}
				catch (Exception e)
				{
	...
	private static void addPhoto(Connection con, String photoId, String orderId, String instanceId) throws SQLException
	{
	...
	public static List getAllOrders(Connection con, String userId, String instanceId) throws SQLException
	{
		...
		try
		{
			...
			while (rs.next())
			{
				...
				try
				{
					order.setCreationDate(new Date(Long.parseLong((String) rs.getString(3))));
				}
				catch (Exception e)
				{
					throw new SQLException(e.getMessage());
				...
				order.setUserName(orga.getUserDetail(Integer.toString(order.getUserId())).getDisplayedName());
	...
	public static Order getOrder(Connection con, String orderId, String instanceId) throws SQLException 
	{
		...
		try
		{
			...
			if (rs.next())
			{
				...
				try
				{
					order.setCreationDate(new Date(Long.parseLong((String) rs.getString(2))));
				}
				catch (Exception e)
				{
					throw new SQLException(e.getMessage());
	...
	public static Date getDownloadDate(Connection con, String orderId, String photoId) throws SQLException
	{
	...
	public static List getAllOrdersToDelete(Connection con, int nbDays) throws SQLException
	{
		...
		try
		{
			...
			while (rs.next())
			{
				...
				try
				{
					order.setCreationDate(new Date(Long.parseLong((String) rs.getString(4))));
				}
				catch (Exception e)
				{
					throw new SQLException(e.getMessage());
	...
	public static void deleteOrder(Connection con, String orderId) throws SQLException
	{
		PreparedStatement prepStmt = null;
		try
		{
	...
	private static void deletePhotoByOrder(Connection con, String orderId, String photoId) throws SQLException
	{
		PreparedStatement prepStmt = null;
		try
		{
