...
public class AlbumMediaEventNotifier
  ...
  public static AlbumMediaEventNotifier get() {
    return ServiceProvider.getService(AlbumMediaEventNotifier.class);
  }

  @Override
  protected AlbumMediaEvent createResourceEventFrom(final ResourceEvent.Type type,
      final AlbumMedia... resource) {
    return new AlbumMediaEvent(type, resource);
  }
}
