...
function reallyClose()
{
    if (window.opener != null) {
      ...
      <%
      	String redirection="";
      	// quand on ajoute un titre on selectionne l'archive dans laquelle le titre va �tre ajout�
      	// quand on ajoute une archive on ne selectionne rien du tout -> la liste de toutes les archives sera affich�e
