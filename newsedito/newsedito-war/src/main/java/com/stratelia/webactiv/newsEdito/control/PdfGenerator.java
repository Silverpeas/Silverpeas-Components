...
public class PdfGenerator
{
    ...
    {
        ResourceLocator pubSettings = new ResourceLocator("com.stratelia.webactiv.util.publication.publicationSettings", "");
     ...
     * @see
     */
    public static void generatePubList(String name, Collection completePubList, String langue) throws NewsEditoException
    {
        SilverTrace.info("NewsEdito", "PdfGenerator.generatePubList", "NewsEdito.MSG_ENTRY_METHOD", "Pdf name = " + name);
        try
        {
            CompletePublication first = (CompletePublication) completePubList.iterator().next();
            String              fileName = FileRepositoryManager.getTemporaryPath(first.getPublicationDetail().getPK().getSpace(), first.getPublicationDetail().getPK().getComponentName()) + name;
            ResourceLocator     message = new ResourceLocator("com.stratelia.webactiv.newsEdito.multilang.newsEditoBundle", langue);
        ...
        {
            throw new NewsEditoException("PdfGenerator.generatePubList", NewsEditoException.WARNING, "NewsEdito.EX_PROBLEM_TO_GENERATE_PUBLI_LIST", e);
        }
    }
     ...
     * @see
     */
    public static void generateArchive(String name, NodeDetail archiveDetail, PublicationBm publicationBm, String langue) throws NewsEditoException
    {
        SilverTrace.info("NewsEdito", "PdfGenerator.generateArchive", "NewsEdito.MSG_ENTRY_METHOD", "Pdf name = " + name);
        try
        {
            String   fileName = FileRepositoryManager.getTemporaryPath(archiveDetail.getNodePK().getSpace(), archiveDetail.getNodePK().getComponentName()) + name;
            // creation of the document with a certain size and certain margins
            Document document = new Document(PageSize.A4, 50, 50, 50, 50);
            ...
            HeaderFooter header = new HeaderFooter(new Phrase(archiveDetail.getName() + " : " + descriptionArchive), false);
            HeaderFooter footer = new HeaderFooter(new Phrase("Page "), new Phrase("."));
        ...
        {
            throw new NewsEditoException("PdfGenerator.generateArchive", NewsEditoException.WARNING, "NewsEdito.EX_PROBLEM_TO_GENERATE_ARCHIVE", e);
        }
    ...
    public static void createFirstPage(Document document, String langue) throws NewsEditoException
    {
        try
        {
            ...
            //java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat(message.getString("dateFormat"));
            Font                       secondFont = new Font(Font.HELVETICA, 20, Font.NORMAL, new Color(0, 0, 0));
            Paragraph                  secondTitle = new Paragraph(message.getString("editeLe") + " " + DateUtil.getOutputDate(new Date(), langue), secondFont);
        ...
        {
            throw new NewsEditoException("PdfGenerator.createFirstPage", NewsEditoException.WARNING, "NewsEdito.EX_PROBLEM_TO_GENERATE_PAGE_ONE", e);
        }
     ...
     * @see
     */
    public static void addMasterTable(Document document, NodeDetail nodeDetail, PublicationBm publicationBm) throws NewsEditoException
    {
        SilverTrace.info("NewsEdito", "PdfGenerator.addMasterTable", "NewsEdito.MSG_ENTRY_METHOD");
        try
        {
        ...
        {
            throw new NewsEditoException("PdfGenerator.addMasterTable", NewsEditoException.WARNING, "NewsEdito.EX_NO_MASTER_ADDED", e);
        }
     ...
     * @see
     */
    public static Section addTitle(Document document, NodeDetail title, int titleCount, PublicationBm publicationBm) throws NewsEditoException
    {

        // we define some fonts
        Font      titleFont = new Font(Font.HELVETICA, 24, Font.NORMAL, new Color(255, 255, 255));

        // Font titleFont = new Font(Font.HELVETICA, 20, Font.NORMAL, new Color(0, 0, 255));
        ...
        {
            throw new NewsEditoException("PdfGenerator.addTitle", NewsEditoException.WARNING, "NewsEdito.EX_NO_TITLE_ADDED", e);
        }
     ...
     * @see
     */
    public static void addPublications(Section section, NodeDetail title, PublicationBm publicationBm) throws NewsEditoException
    {
        try
        {
            Collection pubList = publicationBm.getDetailsByFatherPK(title.getNodePK());
        ...
        {
            throw new NewsEditoException("PdfGenerator.addPublications", NewsEditoException.WARNING, "NewsEdito.EX_NO_PUBLI_ADDED", e);
        }
    ...
    public static void addPublication(Section section, CompletePublication complete)
    {
        ...
        try
        {
            ...
            if ((complete.getInfoDetail() != null) && (complete.getModelDetail() != null))
            {
                ...
                Iterator textIterator = complete.getInfoDetail().getInfoTextList().iterator();
                Iterator imageIterator = complete.getInfoDetail().getInfoImageList().iterator();
                ...
                while (posit != -1)
                {
                    ...
                    else if (toParse.startsWith("%WAIMGDATA%"))
                    {
                        if (imageIterator.hasNext())
                        {
                            ...
                            img = tk.getImage(FileRepositoryManager.getAbsolutePath(imageDetail.getPK().getSpace(), imageDetail.getPK().getComponentName()) + getImagePath() + File.separator + imageDetail.getPhysicalName());
                            waImage = new WAImage(img);*/
                            
							String imagePath = FileRepositoryManager.getAbsolutePath(imageDetail.getPK().getComponentName()) + getImagePath() + File.separator + imageDetail.getPhysicalName();
                      		SilverTrace.info("NewsEdito", "PDFGenerator.addPublication", "root.MSG_PARAM_VALUE", "imagePath = "+imagePath);
     ...
     * @see
     */
    public static void addEditorial(Document document, NodeDetail archiveDetail, PublicationBm publicationBm, String langue) throws NewsEditoException
    {
        ...
        {
            ResourceLocator message = new ResourceLocator("com.stratelia.webactiv.newsEdito.multilang.newsEditoBundle", langue);
            Collection      pubList = publicationBm.getDetailsByFatherPK(archiveDetail.getNodePK());
            Iterator        i = pubList.iterator();
                ...
                try
                {
					...
					while (i.hasNext())
                    {
                        ...
                        if (detail.getImage() != null)
                        {
							...
							String imagePath = FileRepositoryManager.getAbsolutePath(detail.getPK().getComponentName()) + getImagePath() + File.separator + detail.getImage();
							SilverTrace.info("NewsEdito", "PDFGenerator.addEditorial", "root.MSG_PARAM_VALUE", "imagePath = "+imagePath);
							img = Image.getInstance(imagePath);

                            if (img == null)
                            {
                                SilverTrace.info("NewsEdito", "PdfGenerator.addEditorial", "NewsEdito.MSG_CANNOT_RETRIEVE_IMAGE");
                            }
        ...
        {
            throw new NewsEditoException("PdfGenerator.addEditorial", NewsEditoException.WARNING, "NewsEdito.EX_PROBLEM_TO_ADD_EDITO", e);
        }
