...
public class CreateNewsEditoException extends NewsEditoException
{
     ...
     */
    public CreateNewsEditoException(String callingClass, int errorLevel, String message, String extraParams, Exception nested)
    {
     ...
     * @see
     */
    public CreateNewsEditoException(String callingClass, int errorLevel, String message, String extraParams)
    {
     ...
     * @see
     */
    public CreateNewsEditoException(String callingClass, int errorLevel, String message, Exception nested)
    {
     ...
     * @see
     */
    public CreateNewsEditoException(String callingClass, int errorLevel, String message)
    {
