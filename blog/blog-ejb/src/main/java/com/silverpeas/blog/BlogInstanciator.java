...
public class BlogInstanciator implements ComponentsInstanciatorIntf {
  ...
  public void create(Connection con, String spaceId, String componentId, String userId) throws InstanciationException {
	SilverTrace.info("blog","BlogInstanciator.create()","root.MSG_GEN_ENTER_METHOD", "space = "+spaceId+", componentId = "+componentId+", userId ="+userId);
  ...
  {
	SilverTrace.info("blog","BlogInstanciator.delete()","root.MSG_GEN_ENTER_METHOD","space = "+spaceId+", componentId = "+componentId+", userId ="+userId);
  ...
  private void insertRootNodeCategories(Connection con, String componentId, String userId) throws InstanciationException 
	{
		String query = null;
	    ...
	    try {
		    ...
		    throw new InstanciationException("BlogInstanciator.insertRootNodeCategories()",InstanciationException.ERROR, "root.EX_RECORD_INSERTION_FAILED","Query = "+query, se);
	    }
		finally
		{
  	...
  	private void insertRootNodeArchives(Connection con, String componentId, String userId) throws InstanciationException 
	{
		String query = null;
		String creationDate = DateUtil.today2SQLDate();
		query = "INSERT INTO SB_Node_Node(nodeId, nodeName, nodeDescription, nodeCreationDate, nodeCreatorId, " +
	    ...
	    try {
		    ...
		    throw new InstanciationException("BlogInstanciator.insertRootNodeArchives()",InstanciationException.ERROR, "root.EX_RECORD_INSERTION_FAILED","Query = "+query, se);
	    }
		finally
		{
			DBUtil.close(prepStmt);
