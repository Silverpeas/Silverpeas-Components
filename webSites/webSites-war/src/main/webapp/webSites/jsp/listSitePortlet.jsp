...
<view:window>
  <view:tabs>
    <view:tab label='<%=resources.getString("Consulter")%>' action="javascript:wsm.goToAppPage('Main')" selected="true"/>
    <view:tab label='<%=resources.getString("Organiser")%>' action="javascript:wsm.goToAppPage('organize.jsp')" selected="false"/>
    <view:tab label='<%=resources.getString("GML.management")%>' action="javascript:wsm.goToAppPage('manage.jsp')" selected="false"/>
  </view:tabs>
  <view:frame>
