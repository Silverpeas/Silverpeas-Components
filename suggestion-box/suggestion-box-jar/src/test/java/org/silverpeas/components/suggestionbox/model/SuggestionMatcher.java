 ...
 */
public class SuggestionMatcher extends BaseMatcher<Suggestion> {
  ...
  private final Map<PROPERTY, Object> expected = new LinkedHashMap<PROPERTY, Object>();

  protected SuggestionMatcher() {
  }
  ...
  public SuggestionMatcher value(PROPERTY property, Object value) {
    expected.put(property, value);
    return this;
  }

  public static SuggestionMatcher init() {
    return new SuggestionMatcher();
  }
}
