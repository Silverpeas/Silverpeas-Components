...
public interface ProjectManagerBmBusinessSkeleton {
	...
	//public void putBackTask(TaskDetail task, Date previousTaskEndDate) throws RemoteException;
	...
	public Date processEndDate(float charge, String instanceId, Date dateDebut) throws RemoteException;
	
	public void index(String instanceId) throws RemoteException;
	
	public int getOccupationByUser(String userId, Date dateDeb, Date dateFin) throws RemoteException;
	
	public int getOccupationByUser(String userId, Date dateDeb, Date dateFin, int excludedTaskId) throws RemoteException;
}