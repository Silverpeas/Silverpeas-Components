...
public class ProjectManagerCalendarDAO {
	...
	{
		SilverTrace.info("projectManager", "ProjectManagerCalendarDAO.addHolidayDate()", "root.MSG_GEN_ENTER_METHOD", holiday.getDate().toString());
	...
	public static boolean isHolidayDate(Connection con, HolidayDetail holiday) throws SQLException
	{
		...
		SilverTrace.info("projectManager", "ProjectManagerCalendarDAO.isHolidayDate()", "root.MSG_GEN_PARAM_VALUE", "date = "+holiday.getDate().toString());
	...
	public static List getHolidayDates(Connection con, String instanceId) throws SQLException
	{
		...
		SilverTrace.info("projectManager", "ProjectManagerCalendarDAO.getHolidayDates()", "root.MSG_GEN_PARAM_VALUE", "instanceId = "+instanceId);
	...
	public static List getHolidayDates(Connection con, String instanceId, Date beginDate, Date endDate) throws SQLException
	{
		List holidayDates = new ArrayList();
		StringBuffer query = new StringBuffer(128);
		query.append("select * ");
		...
		SilverTrace.info("projectManager", "ProjectManagerCalendarDAO.getHolidayDates()", "root.MSG_GEN_PARAM_VALUE", "instanceId = "+instanceId+", beginDate="+beginDate.toString()+", endDate="+endDate.toString());
	...
	private static Date dbDate2Date(String dbDate, String fieldName) throws SQLException
	{
		...
		{
			throw new SQLException("ProjectManagerCalendarDAO : dbDate2Date("+fieldName+") : format unknown " + e.toString());
		}
		return date;
	}
}