...
public class TaskDetail implements Serializable {
	...
	public TaskDetail(int id, int mereId, int chrono, String nom, String description,
						int organisateurId, int responsableId, float charge, float consomme,
						float raf, int statut, Date dateDebut, Date dateFin,
						String codeProjet, String descriptionProjet,
						int estDecomposee, String instanceId, String path)
	{
		setId(id);
		setMereId(mereId);
		setChrono(chrono);
