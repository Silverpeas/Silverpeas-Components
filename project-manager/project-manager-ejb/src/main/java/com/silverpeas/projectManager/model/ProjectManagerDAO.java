...
public class ProjectManagerDAO {
	...
	public static int addTask(Connection con, TaskDetail task) throws SQLException, UtilException
	{
		SilverTrace.debug("projectManager", "ProjectManagerDAO.addTask()", "root.MSG_GEN_ENTER_METHOD", task.toString());
	...
	public static int addResource(Connection con, TaskResourceDetail resource) throws SQLException, UtilException
	{
		SilverTrace.debug("projectManager", "ProjectManagerDAO.addResources()", "root.MSG_GEN_ENTER_METHOD", resource.toString());
		StringBuffer insertStatement = new StringBuffer(128);
	...
	{
		SilverTrace.debug("projectManager", "ProjectManagerDAO.updateAction()", "root.MSG_GEN_ENTER_METHOD", task.toString());
		
		StringBuffer updateQuery = new StringBuffer(128);
		updateQuery.append("update ").append(PROJECTMANAGER_TASKS_TABLENAME);
		updateQuery.append(" set nom = ? , description = ? , responsableId = ? , charge = ? , consomme = ? , raf = ? , avancement = ? , statut = ? , dateDebut = ? , dateFin = ? , previousId = ? ");
	...
	{
		SilverTrace.debug("projectManager", "ProjectManagerDAO.actionEstDecomposee()", "root.MSG_GEN_ENTER_METHOD", "id = "+id+", estDecomposee = "+estDecomposee);
	...
	public static Collection getResources(Connection con, int taskId, String instanceId) throws SQLException
	{
		...
		SilverTrace.info("projectManager", "ProjectManagerDAO.getResources()", "root.MSG_GEN_PARAM_VALUE", query.toString());
		SilverTrace.info("projectManager", "ProjectManagerDAO.getResources()", "root.MSG_GEN_PARAM_VALUE", "taskId = " + taskId + " instanceId = " + instanceId);
	...
	public static List getAllTasks(Connection con, String instanceId, Filtre filtre) throws SQLException
	{
		...
		SilverTrace.info("projectManager", "ProjectManagerDAO.getAllActions()", "root.MSG_GEN_PARAM_VALUE", query.toString());
	...
	public static List getTasks(Connection con, int actionId, Filtre filtre, String instanceId) throws SQLException
	{
		List tasks = new ArrayList();
		StringBuffer query = new StringBuffer(128);
		query.append("select * ");
	...
	public static List getNextTasks(Connection con, int taskId) throws SQLException
	{
		List tasks = new ArrayList();
		StringBuffer query = new StringBuffer(128);
		query.append("select * ");
	...
	public static TaskDetail getMostDistantTask(Connection con, String instanceId, int taskId) throws SQLException
	{
		StringBuffer query = new StringBuffer(128);
		query.append("select * ");
		query.append("from ").append(PROJECTMANAGER_TASKS_TABLENAME);
	...
	public static List getTasksByMotherId(Connection con, String instanceId, int motherId, Filtre filtre) throws SQLException
	{
		List tasks = new ArrayList();
		StringBuffer query = new StringBuffer(128);
		query.append("select * ");
		...
		SilverTrace.info("projectManager", "ProjectManagerDAO.getTasksByMotherId()", "root.MSG_GEN_ENTER_METHOD", query.toString());
	...
	public static List getTasksNotCancelledByMotherId(Connection con, String instanceId, int motherId, Filtre filtre) throws SQLException
	{
		List tasks = new ArrayList();
		StringBuffer query = new StringBuffer(128);
		query.append("select * ");
		...
		if (filtre == null || filtre.getStatut() == null || filtre.getStatut().equals("-1"))
		{
		...
		SilverTrace.info("projectManager", "ProjectManagerDAO.getTasksNotCancelledByMotherId()", "root.MSG_GEN_ENTER_METHOD", query.toString());
	...
	public static List getTasksByMotherIdAndPreviousId(Connection con, String instanceId, int motherId, int previousId) throws SQLException
	{
		List tasks = new ArrayList();
		StringBuffer query = new StringBuffer(128);
		query.append("select * ");
		...
		SilverTrace.info("projectManager", "ProjectManagerDAO.getTasksByMotherIdAndPreviousId()", "root.MSG_GEN_ENTER_METHOD", query.toString());
	...
	public static int getOccupationByUser(Connection con,String userId, Date dateDeb, Date dateFin, int excludedTaskId) throws SQLException
	{
		...
		query.append("from ").append(PROJECTMANAGER_TASKS_TABLENAME).append(" task, ");
		...
		SilverTrace.info("projectManager", "ProjectManagerDAO.getTasksByMotherId()", "root.MSG_GEN_ENTER_METHOD", query.toString());
		SilverTrace.info("projectManager", "ProjectManagerDAO.getTasksByMotherId()", "root.MSG_GEN_ENTER_METHOD", "dateDebut < "+ dateDeb +" and dateFin > "+ dateFin);
	...
	private static String getSQL(Filtre filtre)
	{
		...
		if (filtre.getDateDebutFrom() != null)
		{
			if (sql.length() > 0)
				sql.append(" AND ");
			sql.append(" dateDebut >= '").append(ProjectManagerDAO.date2DBDate(filtre.getDateDebutFrom())).append("' ");
		}
		...
		if (filtre.getDateDebutTo() != null)
		{
			if (sql.length() > 0)
				sql.append(" AND ");
			sql.append(" dateDebut <= '").append(ProjectManagerDAO.date2DBDate(filtre.getDateDebutTo())).append("' ");
		}
		...
		if (filtre.getDateFinFrom() != null)
		{
			if (sql.length() > 0)
				sql.append(" AND ");
			sql.append(" dateFin >= '").append(ProjectManagerDAO.date2DBDate(filtre.getDateFinFrom())).append("' ");
		}
		...
		if (filtre.getDateFinTo() != null)
		{
			if (sql.length() > 0)
				sql.append(" AND ");
			sql.append(" dateFin <= '").append(ProjectManagerDAO.date2DBDate(filtre.getDateFinTo())).append("' ");
		}
		...
		if (filtre.getRetard() != null && !filtre.getRetard().equals("-1"))
		{
			...
			{
				//les tasks en retard
				sql.append("( dateFin < '").append(ProjectManagerDAO.date2DBDate(today)).append("' AND avancement = 100 ) ");
			}
			else
			{
		...
		if (filtre.getResponsableId() != null && filtre.getResponsableId().length()>0)
		{
			if (sql.length() > 0)
				sql.append(" AND ");
	...
	private static Date dbDate2Date(String dbDate, String fieldName) throws SQLException
	{
		...
		{
			throw new SQLException("ProjectManagerDAO : dbDate2Date("+fieldName+") : format unknown " + e.toString());
		}
		return date;
	}
}