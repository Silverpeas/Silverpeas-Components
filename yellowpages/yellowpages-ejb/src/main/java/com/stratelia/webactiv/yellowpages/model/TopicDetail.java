...
public class TopicDetail extends Object implements java.io.Serializable {
  ...
  /** A int collection which contains the number of contact containing under each sub topics of the topics */
  ...
  /**
	...
	* @since 1.0
	*/
  public TopicDetail(Collection path, NodeDetail nodeDetail, Collection contactDetails, Collection nbContactByTopic) {
  ...
  /**
	...
	* @since 1.0
	*/
  private void init(Collection path, NodeDetail nodeDetail, Collection contactDetails, Collection nbContactByTopic) {
        this.path = path;
  ...
  /**
	...
	* @return a ContactDetail collection containing all the contacts in this topic
  ...
  /**
	...
	* @return a int collection containing the number of contacts of each sub topics
	* @see java.util.Collection
	* @since 1.0
	*/
