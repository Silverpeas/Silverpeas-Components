...
public interface YellowpagesBmSkeleton {
	...
	* @since 1.0
	*/
	public NodePK addToTopic(String id, NodeDetail subtopic) throws RemoteException;
      /**
	...
	* @since 1.0
	*/
	public void addContactToTopic(String pubId, String fatherId) throws RemoteException;
    /**
	...
	* @since 1.0
	*/
	public void deleteContactFromTopic(String pubId, String fatherId) throws RemoteException;
	...
	* @since 1.0
	*/
	public void createInfoModel(String pubId, String modelId) throws RemoteException;
	...
	* @since 1.0
	*/
	public UserCompleteContact getCompleteContact(String pubId) throws RemoteException;
     ...
     * @exception java.sql.SQLException
     */
	public UserCompleteContact getCompleteContactInNode(String ContactId, String nodeId) throws RemoteException;
	...
	*/
	...
	public Collection getContactDetailsByLastName(ContactPK pk, String query) throws RemoteException;
	
	public Collection getContactDetailsByLastNameOrFirstName(ContactPK pk, String query) throws RemoteException;
	
	public Collection getContactDetailsByLastNameAndFirstName(ContactPK pk, String lastName, String firstName) throws RemoteException;
	...
	public boolean isDescendant(String descId, String nodeId) throws RemoteException;
