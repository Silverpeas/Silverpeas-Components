...
public class YellowpagesRuntimeException extends SilverpeasRuntimeException
{
     ...
     * @see
     */
    public YellowpagesRuntimeException(String callingClass, int errorLevel, String message, String extraParams)
    {
     ...
     * @see
     */
    public YellowpagesRuntimeException(String callingClass, int errorLevel, String message, Exception nested)
    {
     ...
     * @see
     */
    public YellowpagesRuntimeException(String callingClass, int errorLevel, String message, String extraParams, Exception nested)
    {
