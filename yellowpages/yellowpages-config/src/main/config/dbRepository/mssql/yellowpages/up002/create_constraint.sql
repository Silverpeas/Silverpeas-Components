ALTER TABLE SC_Contact_Company_GroupFather ADD
	CONSTRAINT PK_SC_Contact_Company_GroupFather PRIMARY KEY
	(
		groupId, fatherId, instanceId
	)   
;

ALTER TABLE SC_Contact_Company ADD
	 CONSTRAINT PK_Contact_Company PRIMARY KEY 
	(
		companyId
	)   
;

ALTER TABLE SC_Contact_Company_Rel ADD
	 CONSTRAINT PK_Contact_Company_Rel PRIMARY KEY 
	(
		contactId,
		companyId
	)   
