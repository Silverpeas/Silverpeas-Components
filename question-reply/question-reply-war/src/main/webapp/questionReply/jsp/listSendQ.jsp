...
<%
	...
	tabbedPane.addTab(resource.getString("questionReply.Qrecues"),routerUrl+"ConsultReceiveQuestions",false, true);  
	tabbedPane.addTab(resource.getString("questionReply.Qremises"),routerUrl+"ConsultSendQuestions",true, false);  
