...
public class QuestionManager 
{
   ...
   * => met à jour publicReplyNumber et/ou privateReplyNumber et replyNumber de la question ainsi que le status à 1 
   */
   ...
   * Affecte le nombre de réponses publiques de la question à 0 : updateQuestion
   * si question en attente, on a demandé à la supprimer : deleteQuestion
   */
   ...
   * Décremente le nombre de réponses privées de la question d'autant : updateQuestion
   */
   ...
   * => la question est supprimée si publicReplyNumber et privateReplyNumber sont à 0 et que la question est close
   * => met à jour publicReplyNumber et/ou privateReplyNumber et replyNumber de la question
   */	
   ...
   */	
   ...
   /*
   * Modifie une réponse
   * => La réponse est supprimée si le status public et le status private sont à 0
   */	
   ...
   */		
   ...
   /*
   * Recupère la liste des questions emises par un utilisateur
   * => Q dont il est l'auteur qui ne sont pas closes ou closes avec réponses privées
   */	
   ...
   /*
   * Recupère la liste des questions recues par un utilisateur
