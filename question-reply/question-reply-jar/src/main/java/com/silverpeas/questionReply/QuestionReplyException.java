...
public class QuestionReplyException extends SilverpeasException{
	...
	*/
	public QuestionReplyException(String callingClass, int errorLevel, String message, String extraParams, Exception nested){
		super(callingClass, errorLevel, message, extraParams, nested);
	}

	public QuestionReplyException(String callingClass, int errorLevel, String message, String extraParams){
		this(callingClass, errorLevel, message, extraParams, null);
	}

	public QuestionReplyException(String callingClass, int errorLevel, String message, Exception nested){
