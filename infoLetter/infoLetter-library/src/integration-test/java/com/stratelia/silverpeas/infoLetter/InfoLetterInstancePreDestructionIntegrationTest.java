...
import com.stratelia.silverpeas.infoLetter.test.WarBuilder4InfoLetter;
...
public class InfoLetterInstancePreDestructionIntegrationTest {
  ...
  @Inject
  private InfoLetterDataInterface infoLetterService;
  ...
  public static Archive<?> createTestArchive() {
    return WarBuilder4InfoLetter.onWarForTestClass(
        InfoLetterInstancePreDestructionIntegrationTest.class).build();
  }
