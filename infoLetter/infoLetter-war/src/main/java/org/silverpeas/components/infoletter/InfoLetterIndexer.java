...
@Singleton
@Named("infoLetter" + ComponentIndexation.QUALIFIER_SUFFIX)
public class InfoLetterIndexer implements ComponentIndexation {
  ...
  public void index(SilverpeasComponentInstance componentInst) {
    infoLetterService.indexInfoLetter(componentInst.getId());
  }
}