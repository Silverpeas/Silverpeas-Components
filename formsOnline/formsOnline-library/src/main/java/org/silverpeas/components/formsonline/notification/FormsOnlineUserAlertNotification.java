...
public class FormsOnlineUserAlertNotification extends AbstractFormsOnlineFormUserNotification {

  public FormsOnlineUserAlertNotification(final FormDetail form, final User user) {
    super(form, user);
  }
