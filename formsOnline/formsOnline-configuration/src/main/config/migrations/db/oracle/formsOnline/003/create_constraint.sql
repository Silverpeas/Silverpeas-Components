...
ALTER TABLE SC_FormsOnline_FormInstances
    ADD CONSTRAINT PK_SC_FormsOL_FormInstances PRIMARY KEY (id);
...
ALTER TABLE SC_FormsOnline_FormInstVali
    ADD CONSTRAINT PK_SC_FormsOL_FormInstVali PRIMARY KEY (id);

ALTER TABLE SC_FormsOnline_FormInstVali
    ADD CONSTRAINT FK_SC_FormsOL_FormInstances_id FOREIGN KEY (formInstId) REFERENCES sc_formsonline_forminstances (id);
