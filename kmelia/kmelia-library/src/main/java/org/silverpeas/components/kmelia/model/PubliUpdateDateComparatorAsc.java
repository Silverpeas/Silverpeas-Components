...
public class PubliUpdateDateComparatorAsc implements Comparator<KmeliaPublication> {
  public static final PubliUpdateDateComparatorAsc comparator = new PubliUpdateDateComparatorAsc();
