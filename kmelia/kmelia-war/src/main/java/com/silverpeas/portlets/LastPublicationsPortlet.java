...
public class LastPublicationsPortlet extends GenericPortlet implements FormNames {
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		String spaceId = (String) session.getAttribute("Silverpeas_Portlet_SpaceId", PortletSession.APPLICATION_SCOPE);
    ...
    private void include(RenderRequest request, RenderResponse response, String pageName) throws PortletException 
    {
        ...
        try {
            PortletRequestDispatcher dispatcher = getPortletContext().getRequestDispatcher("/portlets/jsp/lastPublications/"+pageName);
