...
public class KmeliaValidationTest {
  ...
  @Rule
  public MockByReflectionRule mockByReflection = new MockByReflectionRule();
  private KmeliaValidation kmeliaValidation;
  private KmeliaBm kmeliaService;
  private int counter = 0;

  @Before
  public void setup() {
    counter = 0;
    kmeliaService = mockByReflection
        .mockField(KmeliaServiceProvider.class, KmeliaBm.class, "instance.kmeliaBm");
