...
public class FileDetail extends Object implements java.io.Serializable {
 ...
 private boolean isDirectory;
  ...
  public String getFileURL() {
       return com.stratelia.webactiv.util.FileServerUtils.getUrl(name, path, getMimeType());
  }
  ...
  public String getMimeType() {
   return com.stratelia.webactiv.util.attachment.control.AttachmentController.getMimeType( name );
  }
