...
public interface KmeliaBm extends EJBObject {
	...
	* @since 1.0
	*/
	public TopicDetail goTo(NodePK nodePK, String userId, boolean isTreeStructureUsed, String userProfile, boolean isRightsOnTopicsUsed) throws RemoteException;
	...
	* @since 1.0
	*/
	public NodePK addToTopic(NodePK fatherPK, NodeDetail subtopic) throws RemoteException;
	...
	* @since 1.0
	*/
	public NodePK addSubTopic(NodePK fatherPK, NodeDetail subtopic, String alertType) throws RemoteException;
	...
	* @since 1.0
	*/
	public NodePK updateTopic(NodeDetail topic, String alertType) throws RemoteException;
	...
	*/
	...
	public void changeSubTopicsOrder(String way, NodePK nodePK, NodePK fatherPK) throws RemoteException;

	public void changeTopicStatus(String newStatus, NodePK nodePK, boolean recursiveChanges) throws RemoteException;
	
	public List getTreeview(NodePK nodePK, String profile, boolean coWritingEnable, boolean draftVisibleWithCoWriting, String userId, boolean displayNb, boolean isRightsOnTopicsUsed) throws RemoteException;
	...
	* @since 1.0
	*/
	public Collection getSubscriptionList(String userId, String componentId) throws RemoteException;
	...
	* @since 1.0
	*/
	public void removeSubscriptionToCurrentUser(NodePK topicPK, String userId) throws RemoteException;
	...
	*/
	...
	public Collection getPublicationFathers(PublicationPK pubPK) throws RemoteException;
    /**
	...
	* @since 1.0
	*/
	public String createPublicationIntoTopic(PublicationDetail pubDetail, NodePK fatherPK) throws RemoteException;
	...
	* @since 1.0
	*/
	public void updatePublication(PublicationDetail detail) throws RemoteException;
	...
	*/
	...
	public void deletePublicationImage(PublicationPK pubPK) throws RemoteException;
	
	public void sendPublicationToBasket(PublicationPK pubPK) throws RemoteException;
	public void sendPublicationToBasket(PublicationPK pubPK, boolean kmaxMode) throws RemoteException;
	...
	* @since 1.0
	*/
	public void addPublicationToTopic(PublicationPK pubPK, NodePK fatherPK, boolean isACreation) throws RemoteException;
	...
	* @since 1.0
	*/
	public void deletePublicationFromTopic(PublicationPK pubPK, NodePK fatherPK) throws RemoteException;
	...
	* @since 1.0
	*/
	public void deletePublicationFromAllTopics(PublicationPK pubPK) throws RemoteException;
	...
	* @since 1.0
	*/
	public void createInfoDetail(PublicationPK pubPK, String modelId, InfoDetail infos) throws RemoteException;
	...
	* @since 1.0
	*/
	public void createInfoModelDetail(PublicationPK pubPK, String modelId, InfoDetail infos) throws RemoteException;
	...
	* @since 1.0
	*/
	public UserCompletePublication getUserCompletePublication(PublicationPK pubPK, String userId) throws RemoteException;
	
	public CompletePublication getCompletePublication(PublicationPK pubPK) throws RemoteException;

    public FullPublication getFullPublication(PublicationPK pubPK) throws RemoteException;
    
    public TopicDetail getPublicationFather(PublicationPK pubPK, boolean isTreeStructureUsed, String userId, boolean isRightsOnTopicsUsed) throws RemoteException;

	public Collection getPublicationDetails(Collection publicationIds, String componentId) throws RemoteException;
	...
	* @since 1.0
	*/
	public Collection getPublications(Collection publicationIds, String componentId) throws RemoteException;

    public List getPublicationsToValidate(String componentId) throws RemoteException;
    
    public List getAllValidators(PublicationPK pubPK, int validationType) throws RemoteException;

    public boolean validatePublication(PublicationPK pubPK, String userId, int validationType, boolean force) throws RemoteException;

    public void unvalidatePublication(PublicationPK pubPK, String userId, String refusalMotive, int validationType) throws RemoteException;
    
	public void suspendPublication(PublicationPK pubPK, String refusalMotive, String userId) throws RemoteException;
	...
	* @since 3.0
	*/
	public void draftOutPublication(PublicationPK pubPK, NodePK topicPK, String userProfile) throws RemoteException;
	...
	*/
	 ...
	 */
	public void externalElementsOfPublicationHaveChanged(PublicationPK pubPK) throws RemoteException;
	...
	*/
	public NotificationMetaData getAlertNotificationMetaData(PublicationPK pubPK, NodePK topicPK, String senderName) throws RemoteException;
	...
	* @since 1.0
	*/
	//public Collection getReadingStates(PublicationPK pubPK) throws RemoteException;
	...
	* @since 1.0
	*/
	public void deleteAllReadingControlsByPublication(PublicationPK pubPK) throws RemoteException;
	...
	public void addModelUsed(String[] models, String instanceId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public NodePK addAxis(NodeDetail axis, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public void updateAxis(NodeDetail axis, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public void deleteAxis(String axisId, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public NodeDetail getNodeHeader(String id, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public NodePK addPosition(String fatherId, NodeDetail position, String componentId, String userId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public void updatePosition(NodeDetail position, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public void deletePosition(String positionId, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public Collection getPath(String positionId, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public Collection search(ArrayList combination, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public Collection search(ArrayList combination, int nbDays, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
     */
    public Collection getUnbalancedPublications(String componentId) throws RemoteException;
     ...
     * @throws RemoteException
	 */
	public UserCompletePublication getKmaxCompletePublication(String pubId, String currentUserId) throws RemoteException;
     ...
     * @throws RemoteException
	 */
	public Collection getPublicationCoordinates(String pubId, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
	 */
	public void addPublicationToCombination(String pubId, ArrayList combination, String componentId) throws RemoteException;
     ...
     * @throws RemoteException
	 */
	public void deletePublicationFromCombination(String pubId, String combinationId, String componentId) throws RemoteException;
	...
	* @since 1.0
	*/
	public String createKmaxPublication(PublicationDetail pubDetail) throws RemoteException;
	 ...
	 * @param coordinates
	 */
	public void deleteCoordinates(CoordinatePK coordinatePK, ArrayList coordinates) throws RemoteException;
	...
	public void addAttachmentToPublication(PublicationPK pubPK, String userId, String filename, String description, byte[] contents) throws RemoteException;
	
	public boolean importPublication(String instanceId, String topicId, String spaceId,
