  ...
  private PublicationBm publicationBm = null;
    ...
    private PublicationBm getPublicationBm()
    {
        if (publicationBm == null)
        {
            ...
            {
                SilverTrace.error("kmax", "KmaxStatistics.getPublicationBm", "root.MSG_EJB_CREATE_FAILED" , JNDINames.PUBLICATIONBM_EJBHOME, e);
     ...
     * @see
     */
    public Collection getPublications(String spaceId, String componentId) throws RemoteException
    {
        Collection result = getPublicationBm().getAllPublications(new PublicationPK("useless", spaceId, componentId));
