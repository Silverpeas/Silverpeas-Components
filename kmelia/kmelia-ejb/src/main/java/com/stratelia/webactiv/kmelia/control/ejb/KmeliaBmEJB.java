...
/**
 * This is the KMelia EJB-tier controller of the MVC.
...
public class KmeliaBmEJB implements SessionBean {
  ...
  private int getNbPublicationsOnRoot(String componentId) {
    String parameterValue = getOrganizationController().getComponentParameterValue(componentId, "nbPubliOnRoot");
    SilverTrace.info("kmelia", "KmeliaBmEJB.getNbPublicationsOnRoot()", "root.MSG_GEN_PARAM_VALUE", "parameterValue=" + parameterValue);
    if (StringUtil.isDefined(parameterValue)) {
      ...
      if (KmeliaHelper.isToolbox(componentId)) {
        ...
        ResourceLocator settings = new ResourceLocator("com.stratelia.webactiv.kmelia.settings.kmeliaSettings", "fr");
  ...
  public NodeBm getNodeBm() {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getNodeBm()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_FABRIQUER_NODEBM_HOME", e);
    }
    return nodeBm;
  }
  ...
  public PublicationBm getPublicationBm() {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getPublicationBm()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_FABRIQUER_PUBLICATIONBM_HOME", e);
    }
  ...
  public FavoritBm getFavoriteBm() {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getFavoriteBm()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_FABRIQUER_FAVORITBM_HOME", e);
    }
    return favoriteBm;
  }
  ...
  public SubscribeBm getSubscribeBm() {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getSubscribeBm()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_FABRIQUER_SUBSCRIBEBM_HOME", e);
    }
    return subscribeBm;
  }
  ...
  public StatisticBm getStatisticBm() {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getStatisticBm()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_FABRIQUER_STATISTICBM_HOME", e);
    }
    return statisticBm;
  }
  ...
  public VersioningBm getVersioningBm() {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getVersioningBm()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_FABRIQUER_VERSIONING_EJBHOME", e);
    }
    return versioningBm;
  }
  ...
  public CoordinatesBm getCoordinatesBm() {
    ...
    try {
      CoordinatesBmHome coordinatesBmHome = (CoordinatesBmHome) EJBUtilitaire.getEJBObjectRef(JNDINames.COORDINATESBM_EJBHOME, CoordinatesBmHome.class);
      currentCoordinatesBm = coordinatesBmHome.create();
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.getCoordinatesBm()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_FABRIQUER_COORDINATESBM_HOME", e);
    }
  ...
  public SearchEngineBm getSearchEngineBm() {
    ...
    try {
      SearchEngineBmHome searchEngineBmHome = (SearchEngineBmHome) EJBUtilitaire.getEJBObjectRef(JNDINames.SEARCHBM_EJBHOME, SearchEngineBmHome.class);
  ...
  public TopicDetail goTo(NodePK pk, String userId, boolean isTreeStructureUsed, String userProfile, boolean isRightsOnTopicsUsed) {
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.goTo()", "root.MSG_GEN_PARAM_VALUE", "nodeBm.getDetail(pk) BEGIN");
    try {
        ...
        for (int c = 0; c < children.size(); c++) {
          ...
          if (childId.equals("1") || childId.equals("2") || !child.haveRights()) {
            ...
            if (nodeAvailable) {
              ...
              Iterator descendants = getNodeBm().getDescendantDetails(child).iterator();
              ...
              while (!childAllowed && descendants.hasNext()) {
                ...
                if (descendant.getRightsDependsOn() == rightsDependsOn) {
                  //same rights of father (which is not available)
                  //so it is not available too
                } else {
                  //different rights of father
                  //check if it is available
                  if (orga.isObjectAvailable(descendant.getRightsDependsOn(), ObjectType.NODE, pk.getInstanceId(), userId)) {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.goTo()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DACCEDER_AU_THEME", e);
    }
    SilverTrace.info("kmelia", "KmeliaBmEJB.goTo()", "root.MSG_GEN_PARAM_VALUE", "nodeBm.getDetail(pk) END");

    //get the publications associated to this topic
    if (pk.getId().equals("1")) {
      //Topic = Basket
      SilverTrace.info("kmelia", "KmeliaBmEJB.goTo()", "root.MSG_GEN_PARAM_VALUE", "pubBm.getUnavailablePublicationsByPublisherId(pubPK, currentUser.getId()) BEGIN");
      try {
        //Give the publications associated to basket topic and
        //visibility period expired
        if ("admin".equals(userProfile)) //Admin can see all Publis in the basket.
        {
          userId = null;
        }
        //pubDetails = pubBm.getUnavailablePublicationsByPublisherId(pubPK, userId, "1");
        pubDetails = pubBm.getDetailsByFatherPK(pk, null, false, userId);
      } catch (Exception e) {
        throw new KmeliaRuntimeException("KmeliaBmEJB.goTo()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DAVOIR_LE_CONTENU_DE_LA_CORBEILLE", e);
      }
      SilverTrace.info("kmelia", "KmeliaBmEJB.goTo()", "root.MSG_GEN_PARAM_VALUE", "pubBm.getUnavailablePublicationsByPublisherId(pubPK, currentUser.getId()) END");
      ...
      try {
        ...
        if (nbPublisOnRoot == 0 || !isTreeStructureUsed || KmeliaHelper.isToolbox(pk.getInstanceId())) {
          ...
          pubDetails = pubBm.getDetailsByBeginDateDescAndStatusAndNotLinkedToFatherId(pubPK, PublicationDetail.VALID, nbPublisOnRoot, "1");
          if (isRightsOnTopicsUsed) {
            ...
            while (it.hasNext()) {
              ...
              if (security.isObjectAvailable(pk.getInstanceId(), userId, pubDetail.getPK().getId(), "Publication")) {
        ...
        throw new KmeliaRuntimeException("KmeliaBmEJB.goTo()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DAVOIR_LES_DERNIERES_PUBLICATIONS", e);
      }
      SilverTrace.info("kmelia", "KmeliaBmEJB.goTo()", "root.MSG_GEN_PARAM_VALUE", "pubBm.getUnavailablePublicationsByPublisherId(pubPK, currentUser.getId()) END");
    } else {
      SilverTrace.info("kmelia", "KmeliaBmEJB.goTo()", "root.MSG_GEN_PARAM_VALUE", "pubBm.getDetailsByFatherPK(pk) BEGIN");
      try {
        //get the publication details linked to this topic
        pubDetails = pubBm.getDetailsByFatherPK(pk, "P.pubUpdateDate desc", false);
      } catch (Exception e) {
        throw new KmeliaRuntimeException("KmeliaBmEJB.goTo()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DAVOIR_LA_LISTE_DES_PUBLICATIONS", e);
      }
      SilverTrace.info("kmelia", "KmeliaBmEJB.goTo()", "root.MSG_GEN_PARAM_VALUE", "pubBm.getDetailsByFatherPK(pk) END");
    }
    ...
    return new TopicDetail(newPath, nodeDetail, pubDetails2userPubs(pubDetails), null);
  }
  ...
  private Collection getPathFromAToZ(NodeDetail nd) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getPathFromAToZ()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DAVOIR_LE_CHEMIN_COURANT", e);
    }
    return newPath;
  }
   ...
   * @return If a subtopic of same name already exists a NodePK with id=-1 is returned else the new topic NodePK
  ...
  public NodePK addToTopic(NodePK fatherPK, NodeDetail subTopic) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.addToTopic()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_CREER_LE_THEME", e);
    }
   ...
   * @param subTopic the NodeDetail of the new sub topic
   * @param alertType Alert all users, only publishers or nobody of the topic creation alertType = "All"|"Publisher"|"None"
   * @return If a subtopic of same name already exists a NodePK with id=-1 is returned else the new topic NodePK
   * @see com.stratelia.webactiv.util.node.model.NodeDetail
   * @see com.stratelia.webactiv.util.node.model.NodePK
   * @since 1.0
  ...
  public NodePK addSubTopic(NodePK fatherPK, NodeDetail subTopic, String alertType) {
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.addSubTopic()", "root.MSG_GEN_PARAM_VALUE", "pk = " + pk.toString());
    //Creation alert
    if (!pk.getId().equals("-1")) {
  ...
  private void topicCreationAlert(NodePK pk, NodePK fatherPK, String alertType) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.topicCreationAlert()", "root.MSG_GEN_ENTER_METHOD");
    NodeDetail nodeDetail = null;
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.topicCreationAlert()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DALERTER_POUR_MANIPULATION_THEME", e);
    }

    ResourceLocator message = new ResourceLocator("com.stratelia.webactiv.kmelia.multilang.kmeliaBundle", "fr");
    ResourceLocator message_en = new ResourceLocator("com.stratelia.webactiv.kmelia.multilang.kmeliaBundle", "en");

    //french notifications
    String subject = getTopicCreationAlertSubject(message);
    String body = getTopicCreationAlertContent(nodeDetail, getHTMLNodePath(pk, "fr"), message, "fr");

    //english notifications
    String subject_en = getTopicCreationAlertSubject(message_en);
    String body_en = getTopicCreationAlertContent(nodeDetail, getHTMLNodePath(pk, "en"), message_en, "en");
    ...
    if (!haveRights) {
      if (alertType.equals("All")) {
        ...
        String[] users = getOrganizationController().getUsersIdsByRoleNames(pk.getInstanceId(), profileNames);
      ...
      if (alertType.equals("All")) {
        ...
        String[] users = getOrganizationController().getUsersIdsByRoleNames(pk.getInstanceId(), Integer.toString(rightsDependOn), ObjectType.NODE, profileNames);
        notifMetaData.addUserRecipients(users);
      } else if (alertType.equals("Publisher")) {
        String[] users = getOrganizationController().getUsersIdsByRoleNames(pk.getInstanceId(), Integer.toString(rightsDependOn), ObjectType.NODE, profileNames);
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.topicCreationAlert()", "root.MSG_GEN_PARAM_VALUE", "AlertType alert = " + alertType);
    SilverTrace.info("kmelia", "KmeliaBmEJB.topicCreationAlert()", "root.MSG_GEN_EXIT_METHOD");
  }

  private String getTopicCreationAlertContent(NodeDetail nodeDetail, String htmlNodePath, ResourceLocator message, String contentLanguage) {
    StringBuffer messageText = new StringBuffer();
    messageText.append(message.getString("MailNewTopic")).append("\n");
    messageText.append(message.getString("TopicName")).append(" : ").append(nodeDetail.getName(contentLanguage)).append("\n");
    messageText.append(message.getString("Description")).append(" : ").append(nodeDetail.getDescription(contentLanguage)).append("\n");
    messageText.append(message.getString("Path")).append(" : ").append(htmlNodePath);
  ...
  public NodePK updateTopic(NodeDetail topic, String alertType) {
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.updateTopic()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_MODIFIER_THEME", e);
    }
    //Update Alert
  ...
  public NodeDetail getSubTopicDetail(NodePK pk) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getSubTopicDetail()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DACCEDER_AU_THEME", e);
    }
    return subTopic;
  }
   ...
   * This publications will be visible in the Declassified zone. Delete All subscriptions and favorites on this topics
   * and all descendants
  ...
  public void deleteTopic(NodePK pkToDelete) {
    ...
    try {
      ...
      SilverTrace.info("kmelia", "KmeliaBmEJB.deleteTopic()", "root.MSG_GEN_PARAM_VALUE", "nodesToDelete = " + nodesToDelete.toString());
      ...
      Collection pubFathers = null;		//contains all fatherPKs to a given publication
        ...
        while (itPub.hasNext()) {
          ...
          if (onePubToCheck.getInstanceId().equals(oneNodeToDelete.getInstanceId())) {
            ...
            if (pubFathers.size() >= 2) {
              ...
              SilverTrace.info("kmelia", "KmeliaBmEJB.deleteTopic()", "root.MSG_GEN_PARAM_VALUE", "RemoveFather(pubId, fatherId) with  pubId = " + onePubToCheck.getId() + ", fatherId = " + oneNodeToDelete);
            } else {
              sendPublicationToBasket(onePubToCheck);
              SilverTrace.info("kmelia", "KmeliaBmEJB.deleteTopic()", "root.MSG_GEN_PARAM_VALUE", "RemoveAllFather(pubId) with pubId = " + onePubToCheck.getId());
            }
          } else {
            //remove alias
            aliases.clear();
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.deleteTopic()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_THEME", e);
    }
  ...
  public void changeSubTopicsOrder(String way, NodePK subTopicPK, NodePK fatherPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.changeSubTopicsOrder()", "root.MSG_GEN_ENTER_METHOD", "way = " + way + ", subTopicPK = " + subTopicPK.toString());

    List subTopics = null;
    try {
      subTopics = (List) getNodeBm().getChildrenDetails(fatherPK);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.changeSubTopicsOrder()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_LISTER_THEMES", e);
    }

    if (subTopics != null && subTopics.size() > 0) {
      int indexOfTopic = 0;

      if ("0".equals(fatherPK.getId()) && !KmeliaHelper.isToolbox(subTopicPK.getInstanceId())) {
      ...
      for (int i = 0; i < subTopics.size(); i++) {
        ...
        SilverTrace.info("kmelia", "KmeliaBmEJB.changeSubTopicsOrder()", "root.MSG_GEN_PARAM_VALUE", "updating Node : nodeId = " + nodeDetail.getNodePK().getId() + ", order = " + i);
        try {
          nodeDetail.setOrder(i);
          getNodeBm().setDetail(nodeDetail);
        } catch (Exception e) {
          throw new KmeliaRuntimeException("KmeliaBmEJB.changeSubTopicsOrder()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_MODIFIER_THEME", e);
        }
      }
    }
  }
  ...
  private int getIndexOfNode(String nodeId, List nodes) {
    SilverTrace.debug("kmelia", "KmeliaBmEJB.getIndexOfNode()", "root.MSG_GEN_ENTER_METHOD", "nodeId = " + nodeId);
    ...
    if (nodes != null) {
      for (int i = 0; i < nodes.size(); i++) {
        ...
        if (nodeId.equals(node.getNodePK().getId())) {
          SilverTrace.debug("kmelia", "KmeliaBmEJB.getIndexOfNode()", "root.MSG_GEN_EXIT_METHOD", "index = " + index);
          return index;
        }
        index++;
      }
  ...
  public void changeTopicStatus(String newStatus, NodePK nodePK, boolean recursiveChanges) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.changeTopicStatus()", "root.MSG_GEN_ENTER_METHOD", "newStatus = " + newStatus + ", nodePK = " + nodePK.toString() + ", recursiveChanges = " + recursiveChanges);
    try {
      NodeDetail nodeDetail = null;
      if (!recursiveChanges) {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.changeTopicStatus()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_MODIFIER_THEME", e);
    }
  }

  private void changeTopicStatus(String newStatus, NodeDetail topic) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.changeTopicStatus()", "root.MSG_GEN_ENTER_METHOD", "newStatus = " + newStatus + ", nodePK = " + topic.getNodePK().toString());
    try {
  ...
  public List getTreeview(NodePK nodePK, String profile, boolean coWritingEnable, boolean draftVisibleWithCoWriting, String userId, boolean displayNb, boolean isRightsOnTopicsUsed) {
    ...
    try {
        ...
        for (int t = 0; tree != null && t < tree.size(); t++) {
          ...
          if (!node2Check.haveRights()) {
            ...
            if (t == 0) {
              ...
              int nbPublisOnRoot = Integer.parseInt(orga.getComponentParameterValue(nodePK.getInstanceId(), "nbPubliOnRoot"));
              if (nbPublisOnRoot != 0) {
            ...
            String[] profiles = orga.getUserProfiles(userId, instanceId, rightsDependsOn, ObjectType.NODE);
            if (profiles != null && profiles.length > 0) {
              node2Check.setUserRole(KmeliaHelper.getProfile(profiles));
              allowedTree.add(node2Check);
            } else {
              //check if at least one descendant is available
              Iterator descendants = getNodeBm().getDescendantDetails(node2Check).iterator();
              NodeDetail descendant = null;
              ...
              while (!node2CheckAllowed && descendants.hasNext()) {
                ...
                if (descendant.getRightsDependsOn() == rightsDependsOn) {
                  ...
                  //different rights of father
                  //check if it is available
                  profiles = orga.getUserProfiles(userId, instanceId, descendant.getRightsDependsOn(), ObjectType.NODE);
                  if (profiles != null && profiles.length > 0) //if (orga.isObjectAvailable(descendant.getRightsDependsOn(), descendant.getNodePK().getInstanceId(), userId))
                  {
                    //String[] profiles = orga.getUserProfiles(userId, instanceId, descendant.getRightsDependsOn());
                    node2Check.setUserRole(KmeliaHelper.getProfile(profiles));
      ...
      if (displayNb) {
        ...
        if (profile.equals("user")) {
          ...
          if (coWritingEnable && draftVisibleWithCoWriting) {
            ...
            checkVisibility = true;
            statusSubQuery += "P.pubStatus = 'Valid' OR (P.pubStatus = 'Draft' AND P.pubUpdaterId = '" + userId + "') OR (P.pubStatus = 'Unvalidate' AND P.pubUpdaterId = '" + userId + "') ";
          }
          statusSubQuery += "OR (P.pubStatus = 'ToValidate' AND P.pubUpdaterId = '" + userId + "') ";
          ...
          if (coWritingEnable && draftVisibleWithCoWriting) {
            ...
            statusSubQuery += "P.pubStatus IN ('Valid','ToValidate') OR (P.pubStatus = 'Draft' AND P.pubUpdaterId = '" + userId + "') ";
          }
          statusSubQuery += "OR P.pubUpdaterId = '" + userId + "'";
          statusSubQuery += ")";
        }

        Hashtable distribution = getPublicationBm().getDistribution(nodePK.getInstanceId(), statusSubQuery, checkVisibility);
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getTreeview()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DAVOIR_LA_LISTE_DES_PUBLICATIONS", e);
    }
  }

  private int getNbPublis(NodeDetail node, Hashtable distribution, List allowedNodes) {
    SilverTrace.debug("kmelia", "KmeliaBmEJB.getNbPublis()", "root.MSG_GEN_ENTER_METHOD", "node = " + node.getNodePK().toString());
    int result = 0;
    ...
    while (nodePaths.hasMoreElements()) {
      ...
      //SilverTrace.debug("kmelia","KmeliaBmEJB.getNbPublis()", "root.MSG_GEN_PARAM_VALUE", "nodePath = "+nodePath);
      if (isNodeAllowed(nodePath, allowedNodes) && nodePath.startsWith(node.getFullPath()) && !getLastNodeId(nodePath).equals("1")) {
  ...
  private boolean isNodeAllowed(String nodePath, List allowedNodes) {
    ...
    //SilverTrace.debug("kmelia","KmeliaBmEJB.isNodeAllowed()", "root.MSG_GEN_PARAM_VALUE", "nodePath = "+nodePath+", return false ! ");
    return false;
  }
  ...
  public Collection getSubscriptionList(String userId, String componentId) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getSubscriptionList()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LES_ABONNEMENTS", e);
    }
  }
  ...
  public void removeSubscriptionToCurrentUser(NodePK topicPK, String userId) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.removeSubscriptionToCurrentUser()", "root.MSG_GEN_ENTER_METHOD");
    try {
      getSubscribeBm().removeSubscribe(userId, topicPK);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.removeSubscriptionToCurrentUser()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_ABONNEMENT", e);
    }
    SilverTrace.info("kmelia", "KmeliaBmEJB.removeSubscriptionToCurrentUser()", "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  private void removeSubscriptionsByTopic(NodePK topicPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.removeSubscriptionsByTopic()", "root.MSG_GEN_ENTER_METHOD");
    NodeDetail nodeDetail = null;
    try {
      nodeDetail = getNodeBm().getDetail(topicPK);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.removeSubscriptionsByTopic()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_LES_ABONNEMENTS", e);
    }
    try {
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.removeSubscriptionsByTopic()", "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  public void addSubscription(NodePK topicPK, String userId) {
    ...
    try {
      ...
      SilverTrace.warn("kmelia", "KmeliaBmEJB.addSubscription()", "kmelia.EX_SUBSCRIPTION_ADD_FAILED", "topicId = " + topicPK.getId(), e);
    }
  ...
  public boolean checkSubscription(NodePK topicPK, String userId) {
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.checkSubscription()", SilverpeasRuntimeException.ERROR,
  ...
  private Collection pubDetails2userPubs(Collection pubDetails) {
    ...
    while (iterator.hasNext()) {
      uPub = new UserPublication(userDetails[i], (PublicationDetail) iterator.next());
      i++;
      list.add(uPub);
    }
    return list;
  ...
  public PublicationDetail getPublicationDetail(PublicationPK pubPK) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getPublicationDetail()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LA_PUBLICATION", e);
    }
  }
  ...
  public Collection getPathList(PublicationPK pubPK) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getPathList()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LES_EMPLACEMENTS_DE_LA_PUBLICATION", e);
    }
    try {
  ...
  public String createPublicationIntoTopic(PublicationDetail pubDetail, NodePK fatherPK) {
    ...
    Connection con = getConnection();	//connection usefull for content service
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.createPublicationIntoTopic()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_CREER_LA_PUBLICATION", e);
    } finally {
      freeConnection(con);
    }
  ...
  private String getProfile(String userId, NodePK nodePK) throws RemoteException {
    ...
    if ("yes".equalsIgnoreCase(orgCtrl.getComponentParameterValue(nodePK.getInstanceId(), "rightsOnTopics"))) {
      NodeDetail topic = getNodeBm().getHeader(nodePK);
      if (topic.haveRights()) {
        profile = KmeliaHelper.getProfile(orgCtrl.getUserProfiles(userId, nodePK.getInstanceId(), topic.getRightsDependsOn(), ObjectType.NODE));
      } else {
  ...
  private PublicationDetail changePublicationStatusOnCreation(PublicationDetail pubDetail, NodePK nodePK) throws RemoteException {
    SilverTrace.info("kmelia", "KmeliaBmEJB.changePublicationStatusOnCreation()", "root.MSG_GEN_ENTER_METHOD", "status = " + pubDetail.getStatus());
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.changePublicationStatusOnCreation()", "root.MSG_GEN_EXIT_METHOD", "status = " + pubDetail.getStatus() + ", indexOperation = " + pubDetail.getIndexOperation());
   ...
   */
  private boolean changePublicationStatusOnUpdate(PublicationDetail pubDetail) throws RemoteException {
    ...
    if (pubDetail.isStatusMustBeChecked()) {
      if (PublicationDetail.DRAFT.equals(oldStatus) || PublicationDetail.CLONE.equals(oldStatus)) {
        ...
        String profile = getProfile(pubDetail.getUpdaterId(), (NodePK) fathers.get(0));
        if ("supervisor".equals(profile) || "publisher".equals(profile) || "admin".equals(profile)) {
    ...
    if (fathers == null || fathers.size() == 0 || (fathers.size() == 1 && ((NodePK) fathers.get(0)).getId().equals("1"))) {
  ...
  private void updatePublication(PublicationDetail pubDetail, int updateScope) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.updatePublication()", "root.MSG_GEN_ENTER_METHOD", "updateScope = " + updateScope);
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.updatePublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_MODIFIER_LA_PUBLICATION", e);
    }
    SilverTrace.info("kmelia", "KmeliaBmEJB.updatePublication()", "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  public void pasteDocuments(PublicationPK pubPKFrom, String pubId) throws Exception {
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.pasteDocuments()", "root.MSG_GEN_PARAM_VALUE", documents.size() + " to paste");
    ...
    if (documents.size() > 0) {
      ...
      String[] userIds = getOrganizationController().getUsersIdsByRoleNames(pubPKFrom.getInstanceId(), workingProfiles);

      String userId = null;
      Worker worker = null;
      for (int u = 0; u < userIds.length; u++) {
        userId = (String) userIds[u];
        worker = new Worker(new Integer(userId).intValue(), -1, u, false, true, pubPKFrom.getInstanceId(), "U", false, true, 0);
        workers.add(worker);
      }
    }
    ...
    for (int d = 0; d < documents.size(); d++) {
      ...
      SilverTrace.info("kmelia", "KmeliaBmEJB.pasteDocuments()", "root.MSG_GEN_PARAM_VALUE", "document name = " + document.getName());
      ...
      if (pathTo == null) {
        pathTo = versioningUtil.createPath("useless", pubPKFrom.getInstanceId(), null);
      }
      ...
      for (int v = 1; v < versions.size(); v++) {
        ...
        SilverTrace.info("kmelia", "KmeliaBmEJB.pasteDocuments()", "root.MSG_GEN_PARAM_VALUE", "paste version = " + version.getLogicalName());
  ...
  private String pasteVersionFile(DocumentVersion version, String from, String to) {
    String fileNameFrom = version.getPhysicalName();
    SilverTrace.info("kmelia", "KmeliaBmEJB.pasteVersionFile()", "root.MSG_GEN_ENTER_METHOD", "version = " + fileNameFrom);

    if (!fileNameFrom.equals("dummy")) {
      //we have to rename pasted file (in case the copy/paste append in the same instance)
      String type = fileNameFrom.substring(fileNameFrom.lastIndexOf(".") + 1, fileNameFrom.length());
      ...
      try {
        ...
        throw new KmeliaRuntimeException("KmeliaBmEJB.pasteVersionFile()", SilverpeasRuntimeException.ERROR, "root.EX_FILE_NOT_FOUND", e);
      }
      return fileNameTo;
    } else {
      return fileNameFrom;
   ...
   * If this publication is in the basket or in the DZ, it's deleted from the database
  ...
  public void deletePublication(PublicationPK pubPK) {
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.deletePublication()", "root.MSG_GEN_ENTER_METHOD");
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.deletePublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_LA_PUBLICATION", e);
    }
  ...
  public void deletePublicationImage(PublicationPK pubPK) {
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.deletePublicationImage()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_SUPPRESSION_LA_VIGNETTE", e);
    }
  }
  ...
  public void sendPublicationToBasket(PublicationPK pubPK, boolean kmaxMode) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.sendPublicationToBasket()", "root.MSG_GEN_ENTER_METHOD");
    try {
      ...
      if (kmaxMode) {
        ...
        SilverTrace.info("kmelia", "KmeliaBmEJB.sendPublicationToBasket()", "root.MSG_GEN_PARAM_VALUE", "fatherPKs" + fatherPKs);
        while (it.hasNext()) {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.sendPublicationToBasket()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DENVOYER_LA_PUBLICATION_A_LA_CORBEILLE", e);
    }
    SilverTrace.info("kmelia", "KmeliaBmEJB.sendPublicationToBasket()", "root.MSG_GEN_EXIT_METHOD");
  }
      ...
      try {
        ...
        if (isPublicationInBasket(pubPK, fathers)) {
          ...
          if (pubDetail.getStatus().equalsIgnoreCase(PublicationDetail.VALID)) {
            ...
            updateSilverContentVisibility(pubDetail);
          } else if (pubDetail.getStatus().equalsIgnoreCase(PublicationDetail.TO_VALIDATE)) {
        ...
        throw new KmeliaRuntimeException("KmeliaBmEJB.addPublicationToTopic()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_PLACER_LA_PUBLICATION_DANS_LE_THEME", e);
      }
    }
  ...
  private boolean isPublicationInBasket(PublicationPK pubPK, Collection fathers) throws RemoteException {
    if (fathers == null) {
  ...
  private NodePK sendSubscriptionsNotification(PublicationDetail pubDetail) {
    ...
    if (PublicationDetail.VALID.equals(pubDetail.getStatus())) {
      ...
      try {
        ...
        List positions = getPdcBm().getPositions(silverObjectId, pubDetail.getPK().getInstanceId());
        ...
        SilverTrace.error("kmelia", "KmeliaBmEJB.sendSubscriptionsNotification", "kmelia.CANT_SEND_PDC_SUBSCRIPTIONS", e);
      }
    }
    return oneFather;
  }
    ...
    try {
      ...
      if (!"kmax".equals(pubDetail.getInstanceId())) {
        try {
          ...
          throw new KmeliaRuntimeException("KmeliaBmEJB.sendSubscriptionsNotification()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_PLACER_LA_PUBLICATION_DANS_LE_THEME", re);
        }
      }
      ...
      SilverTrace.warn("kmelia", "KmeliaBmEJB.sendSubscriptionsNotification()", "kmelia.EX_IMPOSSIBLE_DALERTER_LES_UTILISATEURS", "fatherId = " + fatherPK.getId() + ", pubId = " + pubDetail.getPK().getId(), e);
    }
  }

  private String getSubscriptionsNotificationBody(PublicationDetail pubDetail, String htmlPath, ResourceLocator message) {
    StringBuffer messageText = new StringBuffer();
    messageText.append(message.getString("MailNewPublicationSubscription")).append("\n");
    messageText.append(message.getString("PublicationName")).append(" : ").append(pubDetail.getName(message.getLanguage())).append("\n");
    if (StringUtil.isDefined(pubDetail.getDescription(message.getLanguage()))) {
      messageText.append(message.getString("Description")).append(" : ").append(pubDetail.getDescription(message.getLanguage())).append("\n");
    }
  ...
  public void deletePublicationFromTopic(PublicationPK pubPK, NodePK fatherPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.deletePublicationFromTopic()", "root.MSG_GEN_ENTER_METHOD");
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.deletePublicationFromTopic()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_LA_PUBLICATION_DE_CE_THEME", e);
    }
    SilverTrace.info("kmelia", "KmeliaBmEJB.deletePublicationFromTopic()", "root.MSG_GEN_EXIT_METHOD");
  }

  public void deletePublicationFromAllTopics(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.deletePublicationFromAllTopics()", "root.MSG_GEN_ENTER_METHOD");
    try {
      getPublicationBm().removeAllFather(pubPK);
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.deletePublicationFromAllTopics()", "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  public Collection getAllModels() {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getAllModels()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LES_MODELES", e);
    }
  }
  ...
  public ModelDetail getModelDetail(String modelId) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getModelDetail()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LE_DETAIL_DU_MODELE", e);
    }
  }
  ...
  public void createInfoDetail(PublicationPK pubPK, String modelId, InfoDetail infos) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.createInfoDetail()", "root.MSG_GEN_ENTER_METHOD");
    try {
      ModelPK modelPK = new ModelPK(modelId, pubPK);
      checkIndex(pubPK, infos);
      getPublicationBm().createInfoDetail(pubPK, modelPK, infos);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.createInfoDetail()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DENREGISTRER_LE_CONTENU_DU_MODELE", e);
    }
  ...
  public void createInfoModelDetail(PublicationPK pubPK, String modelId, InfoDetail infos) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.createInfoModelDetail()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DENREGISTRER_LE_CONTENU_DU_MODELE", e);
    }
    updatePublication(pubPK, KmeliaHelper.PUBLICATION_CONTENT);
    SilverTrace.info("kmelia", "KmeliaBmEJB.createInfoModelDetail()", "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  public InfoDetail getInfoDetail(PublicationPK pubPK) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getInfoDetail()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LE_CONTENU_DU_MODELE", e);
    }
  }
  ...
  public void updateInfoDetail(PublicationPK pubPK, InfoDetail infos) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.updateInfoDetail()", "root.MSG_GEN_ENTER_METHOD");
    try {
      checkIndex(pubPK, infos);
      getPublicationBm().updateInfoDetail(pubPK, infos);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.updateInfoDetail()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_MODIFIER_LE_CONTENU_DU_MODELE", e);
    }
    updatePublication(pubPK, KmeliaHelper.PUBLICATION_CONTENT);
    SilverTrace.info("kmelia", "KmeliaBmEJB.updateInfoDetail()", "root.MSG_GEN_EXIT_METHOD");
  }

  public void deleteInfoLinks(PublicationPK pubPK, List pubIds) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.deleteInfoLinks()", "root.MSG_GEN_ENTER_METHOD", "pubId = " + pubPK.getId() + ", pubIds = " + pubIds.toString());
    try {
      getPublicationBm().deleteInfoLinks(pubPK, pubIds);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.deleteInfoLinks()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_MODIFIER_LE_CONTENU_DU_MODELE", e);
    }
  }
   ...
   * @since 1.0
   */
  public UserCompletePublication getUserCompletePublication(PublicationPK pubPK, String userId) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getUserCompletePublication()", "root.MSG_GEN_ENTER_METHOD");
    CompletePublication completePublication = null;

    try {
      completePublication = getPublicationBm().getCompletePublication(pubPK);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.getUserCompletePublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LA_PUBLICATION", e);
    }

    PublicationDetail pub = completePublication.getPublicationDetail();
    UserDetail userDetail = getOrganizationController().getUserDetail(pub.getCreatorId());

    SilverTrace.info("kmelia", "KmeliaBmEJB.getUserCompletePublication()", "root.MSG_GEN_EXIT_METHOD");
  ...
  public CompletePublication getCompletePublication(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getCompletePublication()", "root.MSG_GEN_ENTER_METHOD");
    CompletePublication completePublication = null;

    try {
      completePublication = getPublicationBm().getCompletePublication(pubPK);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.getCompletePublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LA_PUBLICATION", e);
    }
  ...
  public FullPublication getFullPublication(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getFullPublication()", "root.MSG_GEN_ENTER_METHOD", "pubPK = " + pubPK.toString());
    ...
    try {
      ...
      List pdcPositions = getPdcBm().getPositions(getSilverObjectId(pubPK), pubPK.getInstanceId());

      fullPublication = new FullPublication(completePublication, attachments, pdcPositions);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.getFullPublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LA_PUBLICATION", e);
    }
  ...
  public TopicDetail getPublicationFather(PublicationPK pubPK, boolean isTreeStructureUsed, String userId, boolean isRightsOnTopicsUsed) {
    ...
    if (fathers != null) {
      ...
      if (!isRightsOnTopicsUsed) {
        ...
        while (allowedFather == null && it.hasNext()) {
          ...
          if (!father.haveRights() || getOrganizationController().isObjectAvailable(father.getRightsDependsOn(), ObjectType.NODE, fatherPK.getInstanceId(), userId)) {
    ...
    String profile = KmeliaHelper.getProfile(getOrganizationController().getUserProfiles(userId, pubPK.getInstanceId()));
    fatherDetail = this.goTo(fatherPK, userId, isTreeStructureUsed, profile, isRightsOnTopicsUsed);
  ...
  public Collection getPublicationFathers(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getPublicationFathers()", "root.MSG_GEN_ENTER_METHOD", "pubPK = " + pubPK.toString());
    Collection fathers = null;
    try {
      fathers = getPublicationBm().getAllFatherPK(pubPK);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.getPublicationFathers()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_UN_PERE_DE_LA_PUBLICATION", e);
    }
    return fathers;
  }

  public Collection getPublicationDetails(Collection publicationIds, String componentId) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getPublicationDetails()", "root.MSG_GEN_ENTER_METHOD");
    Collection publications = null;
    ArrayList publicationPKs = new ArrayList();
    Iterator iterator = publicationIds.iterator();
    while (iterator.hasNext()) {
      PublicationPK pubPK = new PublicationPK((String) iterator.next(), componentId);
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getPublicationDetails()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LES_PUBLICATIONS", e);
    }
   ...
   * @since 1.0
   */
  public Collection getPublications(Collection publicationIds, String componentId) {
  ...
  public List getPublicationsToValidate(String componentId) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getPublicationsToValidate()", "root.MSG_GEN_ENTER_METHOD");
    Collection publications = null;
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getPublicationsToValidate()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LES_PUBLICATIONS_A_VALIDER", e);
    }
    SilverTrace.info("kmelia", "KmeliaBmEJB.getPublicationsToValidate()", "root.MSG_GEN_EXIT_METHOD");
  ...
  private void sendValidationNotification(NodePK fatherPK, PublicationDetail pubDetail, String refusalMotive, String userIdWhoRefuse) {
    ...
    try {
      if (userId != null) {
        ...
        String body = getValidationNotificationBody(pubDetail, refusalMotive, htmlPath, message);
        String subject = getValidationNotificationSubject(pubDetail, message);

        //english notifications
        String htmlPath_en = getHTMLNodePath(fatherPK, "en");
        String body_en = getValidationNotificationBody(pubDetail, refusalMotive, htmlPath_en, message_en);
        String subject_en = getValidationNotificationSubject(pubDetail, message_en);
      ...
      SilverTrace.warn("kmelia", "KmeliaBmEJB.sendValidationNotification()", "kmelia.EX_IMPOSSIBLE_DALERTER_LES_UTILISATEURS", "fatherId = " + fatherPK.getId() + ", pubPK = " + pubDetail.getPK(), e);
    }
  }

  private String getValidationNotificationBody(PublicationDetail pubDetail, String refusalMotive, String htmlPath, ResourceLocator message) {
    StringBuffer messageText = new StringBuffer();
    messageText.append(message.getString("YourPublication")).append("'").append(pubDetail.getName(message.getLanguage())).append("' ");
    ...
    if (PublicationDetail.VALID.equals(pubDetail.getStatus())) {
      ...
      if (refusalMotive != null && refusalMotive.length() > 0) {
        messageText.append(message.getString("RefusalMotive")).append(" : ").append(refusalMotive).append("\n");
      }
    }
  ...
  private String getValidationNotificationSubject(PublicationDetail pubDetail, ResourceLocator message) {
    String subject = "";
    if (PublicationDetail.VALID.equals(pubDetail.getStatus())) {
      //the publication have been validated
  ...
  private String getHTMLNodePath(NodePK nodePK, String language) {
    ...
    if (nodePK != null) {
      try {
        ...
        htmlPath = getSpacesPath(nodePK.getInstanceId(), language) + getComponentLabel(nodePK.getInstanceId(), language) + " > " + displayPath(path, 10, language);
      } catch (RemoteException re) {
        throw new KmeliaRuntimeException("KmeliaBmEJB.getHTMLNodePath()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LES_EMPLACEMENTS_DE_LA_PUBLICATION", re);
      }
    }
    return htmlPath;
  }
  ...
  private void sendAlertToSupervisors(NodePK fatherPK, PublicationDetail pubDetail) {
    if (PublicationDetail.VALID.equalsIgnoreCase(pubDetail.getStatus())) {
      try {
        ...
        String body_en = getAlertBodyToSupervisors(pubDetail, htmlPath_en, message_en);
        ...
        String[] supervisors = getOrganizationController().getUsersIdsByRoleNames(pubDetail.getPK().getInstanceId(), roles);
        SilverTrace.debug("kmelia", "KmeliaBmEJB.alertSupervisors()", "root.MSG_GEN_PARAM_VALUE", supervisors.length + " users in role supervisor !");
        ...
        SilverTrace.warn("kmelia", "KmeliaBmEJB.alertSupervisors()", "kmelia.EX_IMPOSSIBLE_DALERTER_LES_UTILISATEURS", "fatherId = " + fatherPK.getId() + ", pubPK = " + pubDetail.getPK(), e);
      }
    }
  }

  private String getAlertBodyToSupervisors(PublicationDetail pubDetail, String htmlPath, ResourceLocator message) {
    StringBuffer messageText = new StringBuffer();
    messageText.append(message.getStringWithParam("kmelia.SupervisorNotifNewOnLine", pubDetail.getName(message.getLanguage()))).append("\n");
    if (StringUtil.isDefined(htmlPath)) {
      messageText.append(message.getString("Path")).append(" : ").append(htmlPath);
    }
  ...
  public List getAllValidators(PublicationPK pubPK, int validationType) throws RemoteException {
    SilverTrace.debug("kmelia", "KmeliaBmEJB.getAllValidators", "root.MSG_GEN_ENTER_METHOD", "pubId = " + pubPK.getId() + ", validationType = " + validationType);
    if (validationType == -1) {
      String sParam = getOrganizationController().getComponentParameterValue(pubPK.getInstanceId(), "targetValidation");
    ...
    SilverTrace.debug("kmelia", "KmeliaBmEJB.getAllValidators", "root.MSG_GEN_PARAM_VALUE", "validationType = " + validationType);

    //get all users who have to validate
    List allValidators = new ArrayList();
    if (validationType == KmeliaHelper.VALIDATION_TARGET_N || validationType == KmeliaHelper.VALIDATION_TARGET_1) {
    ...
    if (allValidators.isEmpty()) {
      //It's not a targeted validation or it is but no validators has been selected !
      List roles = new ArrayList();
      roles.add("admin");
      roles.add("publisher");

      if (KmeliaHelper.isKmax(pubPK.getInstanceId())) {
        allValidators.addAll(Arrays.asList(getOrganizationController().getUsersIdsByRoleNames(pubPK.getInstanceId(), roles)));
      } else {
        ...
        for (int n = 0; !oneNodeIsPublic && nodePKs != null && n < nodePKs.size(); n++) {
          ...
          if (node != null) {
            SilverTrace.debug("kmelia", "KmeliaBmEJB.getAllValidators", "root.MSG_GEN_PARAM_VALUE", "nodePK = " + nodePK.toString());
            if (!node.haveRights()) {
              allValidators.addAll(Arrays.asList(getOrganizationController().getUsersIdsByRoleNames(pubPK.getInstanceId(), roles)));
              oneNodeIsPublic = true;
            } else {
              allValidators.addAll(Arrays.asList(getOrganizationController().getUsersIdsByRoleNames(pubPK.getInstanceId(), Integer.toString(node.getRightsDependsOn()), ObjectType.NODE, roles)));
            }
          }
        }
      }
    }
    SilverTrace.debug("kmelia", "KmeliaBmEJB.getAllValidators", "root.MSG_GEN_EXIT_METHOD", "pubId = " + pubPK.getId() + ", allValidators = " + allValidators.toString());
    return allValidators;
  }

  private boolean isValidationComplete(PublicationPK pubPK, int validationType) throws RemoteException {
  ...
  public boolean validatePublication(PublicationPK pubPK, String userId, int validationType, boolean force) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.validatePublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_VALIDER_LA_PUBLICATION", e);
    }
    SilverTrace.info("kmelia", "KmeliaBmEJB.validatePublication()", "root.MSG_GEN_EXIT_METHOD", "validationComplete = " + validationComplete);
  ...
  private PublicationDetail getClone(PublicationDetail refPub) {
    ...
    clone.setPk(new PublicationPK(new String(refPub.getPK().getId()), refPub.getPK().getInstanceId()));
  ...
  private PublicationDetail mergeClone(CompletePublication currentPub, String userId) throws RemoteException, FormException, PublicationTemplateException, AttachmentException {
    PublicationDetail currentPubDetail = currentPub.getPublicationDetail();
    ...
    if (!"-1".equals(cloneId)) {
      ...
      if (tempPubli.getModelDetail() != null) {
        if (currentPub.getModelDetail() != null) {
          ...
          ModelPK modelPK = new ModelPK(tempPubli.getModelDetail().getId(), "useless", tempPK.getInstanceId());
      ...
      boolean cloneWysiwyg = WysiwygController.haveGotWysiwyg("useless", tempPK.getInstanceId(), cloneId);
      if (cloneWysiwyg) {
        WysiwygController.copy("useless", tempPK.getInstanceId(), cloneId, "useless", pubPK.getInstanceId(), pubPK.getId(), tempPubli.getPublicationDetail().getUpdaterId());
      }
  ...
  public void unvalidatePublication(PublicationPK pubPK, String userId, String refusalMotive, int validationType) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.unvalidatePublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_REFUSER_LA_PUBLICATION", e);
    }
  ...
  public void suspendPublication(PublicationPK pubPK, String defermentMotive, String userId) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.suspendPublication()", "root.MSG_GEN_ENTER_METHOD");
    try {
      PublicationDetail currentPubDetail = getPublicationBm().getDetail(pubPK);
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.suspendPublication()", "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  private void sendDefermentNotification(PublicationDetail pubDetail, String defermentMotive, String senderId) {
    ...
    try {
      if (userId != null) {
        ...
        String body_en = getDefermentBody(pubDetail, defermentMotive, message_en);
      ...
      SilverTrace.warn("kmelia", "KmeliaBmEJB.sendDefermentNotification()", "kmelia.EX_IMPOSSIBLE_DALERTER_LES_UTILISATEURS", "pubPK = " + pubDetail.getPK(), e);
    }
  }

  private String getDefermentBody(PublicationDetail pubDetail, String defermentMotive, ResourceLocator message) {
    StringBuffer messageText = new StringBuffer();
    messageText.append(message.getStringWithParam("kmelia.YourPublicationHaveBeenRefusedBySupervisor", pubDetail.getName(message.getLanguage()))).append("\n");
    if (defermentMotive != null && defermentMotive.length() > 0) {
      messageText.append(message.getString("RefusalMotive")).append(" : ").append(defermentMotive).append("\n");
    }
  ...
  public void draftOutPublication(PublicationPK pubPK, NodePK topicPK, String userProfile) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.draftOutPublication()", "root.MSG_GEN_ENTER_METHOD", "pubId = " + pubPK.getId());

    try {
      CompletePublication currentPub = getPublicationBm().getCompletePublication(pubPK);
      PublicationDetail pubDetail = currentPub.getPublicationDetail();

      SilverTrace.info("kmelia", "KmeliaBmEJB.draftOutPublication()", "root.MSG_GEN_PARAM_VALUE", "actual status = " + pubDetail.getStatus());
      ...
      SilverTrace.info("kmelia", "KmeliaBmEJB.draftOutPublication()", "root.MSG_GEN_PARAM_VALUE", "new status = " + pubDetail.getStatus());
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.draftOutPublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_MODIFIER_LA_PUBLICATION", e);
    }
  }
  ...
  public void draftInPublication(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.draftInPublication()", "root.MSG_GEN_ENTER_METHOD", "pubPK = " + pubPK.toString());
    try {
      PublicationDetail pubDetail = getPublicationBm().getDetail(pubPK);

      SilverTrace.info("kmelia", "KmeliaBmEJB.draftInPublication()", "root.MSG_GEN_PARAM_VALUE", "actual status = " + pubDetail.getStatus());
      ...
      SilverTrace.info("kmelia", "KmeliaBmEJB.draftInPublication()", "root.MSG_GEN_PARAM_VALUE", "new status = " + pubDetail.getStatus());
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.draftInPublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_MODIFIER_LA_PUBLICATION", e);
    }
  }
  ...
  public NotificationMetaData getAlertNotificationMetaData(PublicationPK pubPK, NodePK topicPK, String senderName) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getAlertNotificationMetaData()", "root.MSG_GEN_ENTER_METHOD");
    PublicationDetail pubDetail = getPublicationDetail(pubPK);
    ...
    String body_en = getNotificationBody(pubDetail, htmlPath_en, message_en, senderName);
    ...
    SilverTrace.info("kmelia", "KmeliaBmEJB.getAlertNotificationMetaData()", "root.MSG_GEN_EXIT_METHOD");
  ...
  private String getNotificationBody(PublicationDetail pubDetail, String htmlPath, ResourceLocator message, String senderName) {
    StringBuffer messageText = new StringBuffer();
  ...
  public void deleteAllReadingControlsByPublication(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.deleteAllReadingControlsByPublication()", "root.MSG_GEN_ENTER_METHOD");
    try {
      //getReadingControlBm().removeReadingControlByPublication(pubPK);
      getStatisticBm().deleteHistoryByAction(new ForeignPK(pubPK.getId(), pubPK.getInstanceId()), 1, "Publication");
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.deleteAllReadingControlsByPublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_LES_CONTROLES_DE_LECTURE", e);
    }
    SilverTrace.info("kmelia", "KmeliaBmEJB.deleteAllReadingControlsByPublication()", "root.MSG_GEN_EXIT_METHOD");
  }
  ...
  private void indexPublications(PublicationPK pubPK) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.indexPublications()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DINDEXER_LES_PUBLICATIONS", e);
    }
    ...
    if (pubs != null) {
      ...
      while (it.hasNext()) {
        ...
        try {
          ...
          if (pub.getStatus() != null && pub.getStatus().equalsIgnoreCase(PublicationDetail.VALID)) {
            pubFathers = (List) getPublicationBm().getAllFatherPK(pubPK);
            //index only valid publications which are not only in dz or basket
            if (pubFathers.size() >= 2) {
              indexPublication(pubPK);
            } else if (pubFathers.size() == 1) {
              NodePK nodePK = (NodePK) pubFathers.get(0);
              //index the valid publication if it is not in the basket
          ...
          throw new KmeliaRuntimeException("KmeliaBmEJB.indexPublications()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DINDEXER_LA_PUBLICATION", "pubPK = " + pubPK.toString(), e);
        }
      }
    }
  }
  ...
  private void indexTopics(NodePK nodePK) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.indexTopics()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DINDEXER_LES_THEMES", e);
    }
  }
   ...
   */
  private void createTodosForPublication(PublicationDetail pubDetail, boolean creation) throws RemoteException {
    if (!creation) {
      /* remove all todos attached to that publication */
      removeAllTodosForPublication(pubDetail.getPK());
    }
    if (PublicationDetail.TO_VALIDATE.equals(pubDetail.getStatus()) || PublicationDetail.TO_VALIDATE.equals(pubDetail.getCloneStatus())) {
  ...
  private void removeAllTodosForPublication(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.removeAllTodosForPublication()", "root.MSG_GEN_ENTER_METHOD", "Enter pubPK =" + pubPK.toString());
  ...
  private void removeTodoForPublication(PublicationPK pubPK, String userId) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.removeTodoForPublication()", "root.MSG_GEN_ENTER_METHOD", "Enter pubPK =" + pubPK.toString());
  ...
  private String getValidationBody(PublicationDetail pubDetail, ResourceLocator message) {
    StringBuffer messageText = new StringBuffer();
    messageText.append(message.getString("PublicationName")).append(" : ").append(pubDetail.getName(message.getLanguage())).append("\n");
    if (StringUtil.isDefined(pubDetail.getDescription(message.getLanguage()))) {
      messageText.append(message.getString("Description")).append(" : ").append(pubDetail.getDescription(message.getLanguage())).append("\n");
  ...
  private String getValidationSubject(PublicationDetail pubDetail, ResourceLocator message) {
    return message.getString("ToValidateShort") + " : " + pubDetail.getName(message.getLanguage());
  }
  ...
  private void sendModificationAlert(int modificationScope, PublicationDetail pubDetail) {
    ...
    if (StringUtil.isDefined(userId)) {
      ...
      String body_en = getModificationBody(pubDetail, modificationScope, message_en);
  ...
  private String getModificationBody(PublicationDetail pubDetail, int modificationScope, ResourceLocator message) {
    StringBuffer messageText = new StringBuffer();
    if (modificationScope == KmeliaHelper.PUBLICATION_HEADER) {
      messageText.append(message.getStringWithParam("kmelia.SupervisorModifyHeader", pubDetail.getName(message.getLanguage())));
    } else {
      messageText.append(message.getStringWithParam("kmelia.SupervisorModifyContent", pubDetail.getName(message.getLanguage())));
    }
  ...
  public int getSilverObjectId(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getSilverObjectId()", "root.MSG_GEN_ENTER_METHOD", "pubId = " + pubPK.getId());
    int silverObjectId = -1;
    PublicationDetail pubDetail = null;
    try {
      silverObjectId = getKmeliaContentManager().getSilverObjectId(pubPK.getId(), pubPK.getInstanceId());
      if (silverObjectId == -1) {
        pubDetail = getPublicationDetail(pubPK);
        silverObjectId = createSilverContent(null, pubDetail, pubDetail.getCreatorId());
      }
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.getSilverObjectId()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
    }
    return silverObjectId;
  }

  private int createSilverContent(Connection con, PublicationDetail pubDetail, String creatorId) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.createSilverContent()", "root.MSG_GEN_ENTER_METHOD", "pubId = " + pubDetail.getPK().getId());
    try {
      return getKmeliaContentManager().createSilverContent(con, pubDetail, creatorId);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.createSilverContent()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
    }
  }

  public void deleteSilverContent(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.deleteSilverContent()", "root.MSG_GEN_ENTER_METHOD", "pubId = " + pubPK.getId());
    Connection con = getConnection();
    try {
      getKmeliaContentManager().deleteSilverContent(con, pubPK);
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.deleteSilverContent()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
    } finally {
      freeConnection(con);
    }
  }
  ...
  private void updateSilverContentVisibility(PublicationDetail pubDetail) {
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.updateSilverContentVisibility()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
    }
  }
  ...
  public Collection getAttachments(PublicationPK pubPK) {
    SilverTrace.info("kmelia", "KmeliaBmEJB.getAttachments()", "root.MSG_GEN_ENTER_METHOD", "pubId = " + pubPK.getId());
    String ctx = "Images";
    AttachmentPK foreignKey = new AttachmentPK(pubPK.getId(), pubPK);
    SilverTrace.info("kmelia", "KmeliaBmEJB.getAttachments()", "root.MSG_GEN_PARAM_VALUE", "foreignKey = " + foreignKey.toString());

    Connection con = null;
    try {
      con = getConnection();
      Collection attachmentList = AttachmentController.searchAttachmentByPKAndContext(foreignKey, ctx, con);
      SilverTrace.info("kmelia", "KmeliaBmEJB.getAttachments()", "root.MSG_GEN_PARAM_VALUE", "attachmentList.size() = " + attachmentList.size());
      return attachmentList;
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.getAttachments()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LES_FICHIERSJOINTS", e);
    }
  }
  ...
  public String getWysiwyg(PublicationPK pubPK) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getAttachments()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LE_WYSIWYG", e);
    }
  ...
  private void indexExternalElementsOfPublication(PublicationPK pubPK) {
    ...
    try {
      ...
      SilverTrace.error("kmelia", "KmeliaBmEJB.indexExternalElementsOfPublication", "Indexing versioning documents failed", "pubPK = " + pubPK.toString(), e);
    }
    ...
    try {
      ...
      SilverTrace.error("kmelia", "KmeliaBmEJB.indexExternalElementsOfPublication", "Indexing comments failed", "pubPK = " + pubPK.toString(), e);
    }
  }
  ...
  private void removeExternalElementsOfPublications(PublicationPK pubPK) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.removeExternalElementsOfPublications()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_LES_FICHIERS_VERSIONNES", e);
    }
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.removeExternalElementsOfPublications()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_LES_COMMENTAIRES", e);
    }
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.removeExternalElementsOfPublications", SilverpeasRuntimeException.ERROR, "root.EX_DELETE_ATTACHMENT_FAILED", e);
    }
  }
  ...
  private void removeXMLContentOfPublication(PublicationPK pubPK) {
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.removeXMLContentOfPublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_SUPPRIMER_LE_CONTENU_XML", e);
  ...
  private Connection getConnection() {
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getConnection()", SilverpeasRuntimeException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
    }
  }
  ...
  private void freeConnection(Connection con) {
    if (con != null) {
      try {
        ...
        SilverTrace.error("kmelia", "KmeliaBmEJB.freeConnection()", "root.EX_CONNECTION_CLOSE_FAILED", "", e);
      }
    }
  }
  ...
  public void addModelUsed(String[] models, String instanceId) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.addModelUsed()", SilverpeasRuntimeException.ERROR, "kmelia.IMPOSSIBLE_D_AJOUTER_LES_MODELES", e);
    } finally {
      // fermer la connexion
      freeConnection(con);
    }
  ...
  public Collection getModelUsed(String instanceId) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getModelUsed()", SilverpeasRuntimeException.ERROR, "kmelia.IMPOSSIBLE_DE_RECUPERER_LES_MODELES", e);
    } finally {
      // fermer la connexion
      freeConnection(con);
    }
  ...
  public List getAxis(String componentId) {
    ...
    SilverTrace.info("kmax", "KmeliaBmEjb.getAxis()", "root.MSG_GEN_PARAM_VALUE", "componentId = " + componentId + " sortField=" + sortField + " sortOrder=" + sortOrder);
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEJB.getAxis()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DOBTENIR_LES_AXES", e);
    }
    return axis;
  }
  ...
  public List getAxisHeaders(String componentId) {
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEJB.getAxisHeaders()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DOBTENIR_LES_ENTETES_DES_AXES", e);
    }
    return axisHeaders;
  }
  ...
  public NodePK addAxis(NodeDetail axis, String componentId) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.addAxis()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_CREER_L_AXE", e);
    }
    return axisPK;
  }
  ...
  public void updateAxis(NodeDetail axis, String componentId) {
    ...
    SilverTrace.info("kmax", "KmeliaBmEjb.updateAxis()", "root.MSG_GEN_PARAM_VALUE", "componentId = " + componentId + " nodePk.getComponentId()=" + axis.getNodePK().getInstanceId());
    try {
      getNodeBm().setDetail(axis);
    } catch (Exception e) {
      throw new KmaxRuntimeException("KmeliaBmEJB.updateAxis()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_MODIFIER_L_AXE", e);
    }
  }
  ...
  public void deleteAxis(String axisId, String componentId) {
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEJB.deleteAxis()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_SUPPRIMER_L_AXE", e);
    }
  }
  ...
  private void removeCoordinatesByPoints(ArrayList nodePKs, String componentId) {
    ...
    try {
      getCoordinatesBm().deleteCoordinatesByPoints(coordinatePK, coordinatePoints);
    } catch (Exception e) {
      throw new KmaxRuntimeException("KmeliaBmEJB.removeCoordinatesByPoints()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_SUPPRIMER_LES_COORDONNEES_PAR_UN_POINT", e);
    }
  }
  ...
  private NodeDetail getNodeHeader(NodePK pk) {
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEJB.getNodeHeader()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DOBTENIR_LE_NOEUD", e);
    }
    return nodeDetail;
  }

  public NodePK addPosition(String fatherId, NodeDetail position, String componentId, String userId) {
    SilverTrace.info("kmax", "KmeliaBmEjb.addPosition()", "root.MSG_GEN_PARAM_VALUE", "fatherId = " + fatherId + " And position = " + position.toString());
    ...
    SilverTrace.info("kmax", "KmeliaBmEjb.addPosition()", "root.MSG_GEN_PARAM_VALUE", "fatherDetail = " + fatherDetail.toString());
    try {
      componentPK = getNodeBm().createNode(position, fatherDetail);
    } catch (Exception e) {
      throw new KmaxRuntimeException("KmeliaBmEjb.addPosition()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DAJOUTER_UNE_COMPOSANTE_A_L_AXE", e);
    }
    return componentPK;
  }
  ...
  public void updatePosition(NodeDetail position, String componentId) {
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEjb.updatePosition()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_MODIFIER_LA_COMPOSANTE_DE_L_AXE", e);
    }
  }
  ...
  public void deletePosition(String positionId, String componentId) {
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEjb.deletePosition()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_SUPPRIMER_LA_COMPOSANTE_DE_L_AXE", e);
    }
  }
  ...
  public Collection getPath(String id, String componentId) {
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEjb.getPath()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DOBTENIR_LE_CHEMIN", e);
    }
    return newPath;
  }
  ...
  public Collection getKmaxPathList(PublicationPK pubPK) {
    ...
    try {
      coordinates = (ArrayList) getPublicationCoordinates(pubPK.getId(), pubPK.getInstanceId());
    } catch (Exception e) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.getKmaxPathList()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DOBTENIR_LES_EMPLACEMENTS_DE_LA_PUBLICATION", e);
    }
    return coordinates;
  }
  ...
  public Collection search(ArrayList combination, int nbDays, String componentId) {
    Collection publications = searchPublications(combination, componentId);
    SilverTrace.info("kmax", "KmeliaBmEjb.search()", "root.MSG_GEN_PARAM_VALUE", "publications = " + publications);
    return pubDetails2userPubs(filterPublicationsByBeginDate(publications, nbDays));
  }

  private Collection searchPublications(ArrayList combination, String componentId) {
    ...
    try {
      ...
      if (combination.size() == 0) {
        ...
        if (combination != null && combination.size() > 0) {
          coordinates = getCoordinatesBm().getCoordinatesByFatherPaths(combination, coordinatePK);
        }
        if (coordinates.size() > 0) {
          publications = getPublicationBm().getDetailsByFatherIds((ArrayList) coordinates, pk, false);
        }
      }
    } catch (Exception e) {
      throw new KmaxRuntimeException("KmeliaBmEJB.search()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DOBTENIR_LA_LISTE_DES_RESULTATS", e);
    }
    return publications;
  }
  ...
  public Collection getUnbalancedPublications(String componentId) {
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEJB.getUnbalancedPublications()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DOBTENIR_LA_LISTE_DES_PUBLICATIONS_NON_CLASSEES", e);
    }
    return pubDetails2userPubs(publications);
  }

  private Collection filterPublicationsByBeginDate(Collection publications, int nbDays) {
  ...
  private void indexAxis(String componentId) {
    ...
    try {
      ...
      if (nodes != null) {
        ...
        while (it.hasNext()) {
          node = (NodeDetail) it.next();
          if (node.getName().equalsIgnoreCase("corbeille") && node.getNodePK().getId().equals("1")) {
      ...
      throw new KmaxRuntimeException("KmeliaBmEjb.indexAxis()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DINDEXER_LES_AXES", e);
    }
  }
  ...
  public void addPublicationToCombination(String pubId, ArrayList combination, String componentId) {
    SilverTrace.info("kmax", "KmeliaBmEJB.addPublicationToCombination()", "root.MSG_GEN_PARAM_VALUE", "combination =" + combination.toString());
    ...
    try {
      ...
      while (it.hasNext()) {
        ...
        SilverTrace.info("kmax", "KmeliaBmEjb.addPublicationToCombination()", "root.MSG_GEN_PARAM_VALUE", "avant nodeBm.getPath() ! i = " + i);
        Collection path = nodeBm.getPath(nodePK);
        SilverTrace.info("kmax", "KmeliaBmEjb.addPublicationToCombination()", "root.MSG_GEN_PARAM_VALUE", "path for nodeId " + nodeId + " = " + path.toString());
      ...
      getPublicationBm().addFather(pubPK, new NodePK(new Integer(coordinateId).toString(), pubPK));
    } catch (Exception e) {
      throw new KmaxRuntimeException("KmeliaBmEjb.addPublicationToCombination()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DAJOUTER_LA_PUBLICATION_A_CETTE_COMBINAISON", e);
    }
  }

  protected boolean checkCombination(Collection coordinates, ArrayList combination) {
  ...
  public void deleteCoordinates(CoordinatePK coordinatePK, ArrayList coordinates) {
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEJB.deleteCoordinates()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_SUPPRIMER_LES_COORDINATES", e);
    }
  }

  public void deletePublicationFromCombination(String pubId, String combinationId, String componentId) {
    SilverTrace.info("kmax", "KmeliaBmEjb.deletePublicationFromCombination()", "root.MSG_GEN_PARAM_VALUE", "combinationId = " + combinationId.toString());
    PublicationPK pubPK = new PublicationPK(pubId, componentId);
    ...
    try {
      ...
      throw new KmaxRuntimeException("KmeliaBmEjb.deletePublicationFromCombination()", SilverpeasRuntimeException.ERROR, "kmax.EX_IMPOSSIBLE_DE_SUPPRIMER_LA_COMBINAISON_DE_LA_PUBLICATION", e);
    }
  }
  ...
  public String createKmaxPublication(PublicationDetail pubDetail) {
    ...
    try {
      //create the publication
      pubDetail = changePublicationStatusOnCreation(pubDetail, new NodePK("useless", pubDetail.getPK()));
      pubPK = getPublicationBm().createPublication(pubDetail);
      pubDetail.getPK().setId(pubPK.getId());
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.createKmaxPublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DE_CREER_LA_PUBLICATION", e);
    } finally {
      freeConnection(con);
    }
  ...
  public Collection getAlias(PublicationPK pubPK) {
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.getAlias()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DAVOIR_LES_ALIAS_DE_PUBLICATION", e);
    }
  }
  ...
  public void setAlias(PublicationPK pubPK, List alias) {
    ...
    try {
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.setAlias()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DENREGISTRER_LES_ALIAS_DE_PUBLICATION", e);
    }
  }
  ...
  public void addAttachmentToPublication(PublicationPK pubPK, String userId, String filename, String description, byte[] contents) {
    ...
    String versioning = getOrganizationController().getComponentParameterValue(pubPK.getComponentName(), "versionControl");
    ...
    String physicalName = new Long(creationDate.getTime()).toString() + "." + type;
    ...
    try {
      ...
      if (contents != null && contents.length > 0) {
        ...
        String mimeType = javax.activation.MimetypesFileTypeMap.getDefaultFileTypeMap().getContentType(f);
        ...
        if (versioningActive) {
          ...
          Document document = new Document(docPK, pubForeignKey, logicalName, description, -1, user_id, creationDate, null, null, null, null, 0, 0);

          int majorNumber = 1;
          int minorNumber = 0;

          DocumentVersion newVersion = new DocumentVersion(null, docPK, majorNumber, minorNumber, user_id,
                  creationDate, "", 0, 0, physicalName, logicalName, mimeType, (int) size, pubPK.getComponentName());

          //create the document with its first version
          DocumentPK documentPK = getVersioningBm().createDocument(document, newVersion);
          document.setPk(documentPK);

          //DocumentVersion version = getVersioningBm().addDocumentVersion(document, newVersion);

          if (newVersion.getType() == DocumentVersion.TYPE_PUBLIC_VERSION) {
            CallBackManager.invoke(CallBackManager.ACTION_VERSIONING_UPDATE, newVersion.getAuthorId(), document.getForeignKey().getInstanceId(), document.getForeignKey().getId());
          ...
          AttachmentDetail ad = new AttachmentDetail(atPK, physicalName, logicalName, description, mimeType, size, context, creationDate, pubForeignKey);
          ad.setAuthor(userId);
      ...
      throw new KmeliaRuntimeException("KmeliaBmEJB.addAttachmentToPublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DAJOUTER_ATTACHEMENT", fnfe);
    } catch (IOException ioe) {
      throw new KmeliaRuntimeException("KmeliaBmEJB.addAttachmentToPublication()", SilverpeasRuntimeException.ERROR, "kmelia.EX_IMPOSSIBLE_DAJOUTER_ATTACHEMENT", ioe);
    }
  }
  ...
  public boolean importPublication(String componentId, String topicId, String spaceId,
          String userId, Map publiParams, Map formParams, String language, String xmlFormName,
    ...
    return publicationImport.importPublication(
            publiParams, formParams, language, xmlFormName, discrimatingParameterName, userProfile);
  }
