...
public class FullPublication extends Object implements java.io.Serializable {
	...
	public FullPublication(CompletePublication publication, List attachments, List pdcPositions) {
        init(publication, attachments, pdcPositions);
	}

	private void init(CompletePublication publication, List attachments, List pdcPositions) {
