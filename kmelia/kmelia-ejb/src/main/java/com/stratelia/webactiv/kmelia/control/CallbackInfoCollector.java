...
class CallbackInfoCollector extends HTMLEditorKit.ParserCallback
{
    ...
    {
	  SilverTrace.info("kmelia", "CallbackInfoCollector.handleEndTag", "root.MSG_ENTRY_METHOD", "t = "+t.toString());
    ...
    {
	  SilverTrace.info("kmelia", "CallbackInfoCollector.handleStartTag", "root.MSG_ENTRY_METHOD", "t = "+t.toString());
