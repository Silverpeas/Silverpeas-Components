 ...
 * Manager role profile of a Resources Manager application.
 *
 * @author mmoquillon
 */
@Technical
...
public class ResourcesManagersSynchronizer {
   ...
   * application and by taking into account the given users have been removed from the Manager
   * Profile of the applications. The specified users could could have been explicitly removed or
   * have been in a group that has been removed from the Managers profile.
   *
  ...
  /**
   * Synchronizes the list of managers of all the resources managed by all the Resources Manager
   * applications and by taking into account the given users have been removed from the Manager
   * Profile of the applications. The specified users could could have been explicitly removed or
   * have been in a group that has been removed from the Managers profile.
   *
   * @param removedUsersId a set with the unique identifiers of the removed users.
   */
  @Transactional
  public void synchronizeAll(@NonNull Set<String> removedUsersId) {
    Objects.requireNonNull(removedUsersId);
