...
public class DataWarningScheduler extends SilverpeasBean
{
	...
	public DataWarningScheduler(String instanceId, int numberOfTimes, int numberOfTimesMoment, int minits, int hours, int dayOfWeek, int dayOfMonth, int month, int schedulerState)
	{
		super();
