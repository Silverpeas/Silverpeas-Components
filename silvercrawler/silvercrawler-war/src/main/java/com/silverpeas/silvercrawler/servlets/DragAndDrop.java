...
public class DragAndDrop extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse res)
    ...
    try {
      ...
      HttpSession session = SessionManager.getInstance().getSessionInfo(sessionId).getHttpSession();
      SilverCrawlerSessionController sessionController = (SilverCrawlerSessionController) session.getAttribute("Silverpeas_SilverCrawler_"+instanceId);
