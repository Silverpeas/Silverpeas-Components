...
public class IndexSelectedFoldersHandler extends FunctionHandler {
  ...
  public String getDestination(SilverCrawlerSessionController sessionController,
    ...
    SilverTrace.debug("silverCrawler", "IndexSelectedFoldersHandler.getDestination()",
        "root.MSG_GEN_PARAM_VALUE", "IndexSelectedFolders");
    ...
    if (!userHighestRole.equals("admin")) {
      throw new SilverCrawlerForbiddenActionException("IndexSelectedFoldersHandler.getDestination",
