...
public class GoToCrawler extends GoTo
{
        ...
        throws Exception
    {
        ...
        SilverTrace.info("formManager", "GoToCrawler.getDestination", "root.MSG_GEN_PARAM_VALUE", "componentId = " + componentId);
        String gotoURL = URLManager.getURL(null, componentId) + "SubDirectoryFromResult?DirectoryPath=" + path;
