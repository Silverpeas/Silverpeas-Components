...
public class HistoryDAO
{
	...
	public static Collection getHistoryDetailByObject(Connection con, String tableName, String path, String componentId) throws SQLException
	{
		SilverTrace.info("silverCrawler", "HistoryDAO.getHistoryDetailByObject", "root.MSG_GEN_ENTER_METHOD");
	...
	public static Collection getHistoryDetailByObjectAndUser(Connection con, String tableName, String path, String userId, String componentId) throws SQLException
	{
		SilverTrace.info("silverCrawler", "HistoryDAO.getHistoryDetailByObjectAndUser()", "root.MSG_GEN_ENTER_METHOD");
		String     selectStatement = "select * from " + tableName + " where path = ? and componentId = ? and userId = ? "
