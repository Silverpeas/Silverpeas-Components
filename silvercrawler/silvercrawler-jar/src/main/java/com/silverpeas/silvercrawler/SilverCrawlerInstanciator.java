...
public class SilverCrawlerInstanciator implements ComponentsInstanciatorIntf {
  ...
  public void create(Connection con, String spaceId, String componentId, String userId)
    ...
    SilverTrace
        .info("silverCrawler", "SilverCrawlerInstanciator.create()", "root.MSG_GEN_ENTER_METHOD",
  ...
  public void delete(Connection con, String spaceId, String componentId, String userId)
      throws InstanciationException {
    SilverTrace
        .info("silverCrawler", "SilverCrawlerInstanciator.delete()", "root.MSG_GEN_ENTER_METHOD",
            "space = " + spaceId + ", componentId = " + componentId + ", userId =" + userId);
    SilverTrace
        .info("silverCrawler", "SilverCrawlerInstanciator.delete()", "root.MSG_GEN_EXIT_METHOD");
  }
}