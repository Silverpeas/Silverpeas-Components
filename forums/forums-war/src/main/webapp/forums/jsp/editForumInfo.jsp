...
<body id="creation-page" class="forum" bgcolor="#FFFFFF" <%addBodyOnload(out, fsc, "document.forumsForm.forumName.focus();");%>>
<%
...
<%     } %>
    ...
    <div class="field" id="descriptionArea">
      ...
      <div class="champs">
        <textarea name="forumDescription" cols="49" rows="6" wrap="VIRTUAL"><%if (update) {%><%=forum.getDescription()%><%}%></textarea>
      </div>
    </div>
    <!-- Forum keywords  -->
    ...
    <div class="field" id=mandatoryArea">
      <span class="txtnote">(<img src="<%=context%>/util/icons/mandatoryField.gif" width="5" height="5" />&nbsp;=&nbsp;<fmt:message key="reqchamps" />)</span>
    </div>
  </div>
</fieldset>
<%
...
<fieldset id="moderatorsFieldset" class="skinFieldset">
  ...
  <table width="98%" cellpadding="0" cellspacing="0" border="0">
      <tr>
          <td nowrap align="right"><span class="txtlibform"><fmt:message key="availableUsers" /> : </span>&nbsp;</td>
          <td nowrap width="10%">&nbsp;</td>
          <td nowrap align="left">&nbsp;<span class="txtlibform"><fmt:message key="moderators" /> : </span></td>
      </tr>
      <tr>
            ...
            <td nowrap align="center" valign="middle">
                <center>
                    <table border="0" cellpadding="0" cellspacing="0" width="37">
                        <tr>
                            <td class="intfdcolor" width="37"><a href="javascript:moveUsers('>');"><img src="icons/bt_fleche-d.gif" width="37" height="24" border="0"/></a>
                            <a href="javascript:moveUsers('<');"><img src="icons/bt_fleche-g.gif" width="37" height="24" border="0"/></a>
                            <a href="javascript:removeAllUsers();"><img src="icons/bt_db-fleche-d.gif" width="37" height="24" border="0"/></a>
