...
public class ForumsInstanciator extends SQLRequest implements ComponentsInstanciatorIntf {
	...
	public void create(Connection con, String spaceId, String componentId, String userId) throws InstanciationException {
		SilverTrace.info("forums", "ForumsInstanciator.create()", "forums.MSG_CREATE_WITH_SPACE_AND_COMPONENT",
	...
	*/
	private void deleteDataOfInstance(Connection con, String componentId, String suffixName) throws InstanciationException {
		...
		try {
		    ...
		    InstanciationException ie = new InstanciationException("ForumsInstanciator.deleteDataOfInstance()",
