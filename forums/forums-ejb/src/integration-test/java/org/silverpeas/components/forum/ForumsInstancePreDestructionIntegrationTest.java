...
import org.silverpeas.components.forum.test.WarBuilder4Forums;
...
public class ForumsInstancePreDestructionIntegrationTest {

  private static final String TABLE_CREATION_SCRIPT =
      "/org/silverpeas/components/forum/create-database.sql";
  private static final String DATASET_SCRIPT =
      "/org/silverpeas/components/forum/forums-dataset.sql";
  ...
  public static Archive<?> createTestArchive() {
    return WarBuilder4Forums.onWarForTestClass(ForumsInstancePreDestructionIntegrationTest.class)
        .build();
  }
