...
public class ChatInstanciator extends Object implements ComponentsInstanciatorIntf
{
    ...
    {
      SilverTrace.info("chat","ChatInstanciator.create()", "root.MSG_GEN_PARAM_VALUE","spaceId = "+spaceId+" , componentId = "+componentId);
    }
    ...
    public void delete(Connection con, String spaceId, String componentId, String userId) throws InstanciationException
    {
		...
		{
	        SilverTrace.info("chat","ChatInstanciator.delete()", "root.EX_RECORD_DELETE_FAILED","componentId " + componentId );
		}
