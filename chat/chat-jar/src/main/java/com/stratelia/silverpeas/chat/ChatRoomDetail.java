...
public class ChatRoomDetail extends AbstractI18NBean implements SilverContentInterface, Serializable
{
	...
	//constructor
	public ChatRoomDetail(String instanceId, String id, String name, String comment, String creatorId)
    {
