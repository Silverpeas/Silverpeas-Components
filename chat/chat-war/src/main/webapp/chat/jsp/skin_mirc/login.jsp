...
<%@ page import="jChatBox.Util.*,jChatBox.Chat.*,jChatBox.*,java.util.*,java.text.SimpleDateFormat,org.silverpeas.silvertrace.*,com.stratelia.silverpeas.chat.control.*" %>
