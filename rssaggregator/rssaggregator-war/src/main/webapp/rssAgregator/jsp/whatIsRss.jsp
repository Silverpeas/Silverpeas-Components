...
<div class="txtlibform"><%=resource.getString("rss.explanation10")%></div>
	...
	<tr><td>Liberation.fr - A la une</td><td><a href="http://www.liberation.fr/rss.php" target=_blank><img src="<%=resource.getIcon("rss.logoRSS")%>" border="0"></a></td><td>ALL HTML - Le Portail d�di� aux Webmasters</td><td><a href="http://www.allhtml.com/news/news.xml" target=_blank><img src="<%=resource.getIcon("rss.logoRSS")%>" border="0"></a></td></tr>
	...
	<tr><td>RTL Info</td><td><a href="http://www.rtl.fr/referencement/rtlinfo.asp" target=_blank><img src="<%=resource.getIcon("rss.logoRSS")%>" border="0"></a></td><td>Journal du Net D�veloppeurs</td><td><a href="http://developpeur.journaldunet.com/jdnetdev.xml" target=_blank><img src="<%=resource.getIcon("rss.logoRSS")%>" border="0"></a></td></tr>
	...
	<tr><td>Cit� des Sciences</td><td><a href="http://www.cite-sciences.fr/rss/sciences_actu_fr_20.xml" target=_blank><img src="<%=resource.getIcon("rss.logoRSS")%>" border="0"></a></td><td>RTL Sport</td><td><a href="http://www.rtl.fr/referencement/rtlsport.asp" target=_blank><img src="<%=resource.getIcon("rss.logoRSS")%>" border="0"></a></td></tr>
