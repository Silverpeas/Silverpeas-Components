...
public class WhitePagesInstanciator extends SQLRequest implements ComponentsInstanciatorIntf {
  ...
  public void create(Connection con, String spaceId, String componentId, String userId) throws InstanciationException {
  		try { 
			...
			Admin admin = new Admin();			
	  		...
	  		//PublicationTemplateManager.addPublicationTemplate(componentId, template);
			PublicationTemplateManager.addDynamicPublicationTemplate(componentId, template);
	  	
		} catch (Exception e) {
		    throw new InstanciationException("WhitePagesInstanciator.create()", SilverpeasException.ERROR, "whitePages.EX_CANT_ADD_TEMPLATE", e);
		}  		
  }
  ...
  public void delete(Connection con, String spaceId, String componentId, String userId) throws InstanciationException {
		...
		try {
		    ...
		    throw new InstanciationException("WhitePagesInstanciator.delete()", SilverpeasException.ERROR, "whitePages.EX_CANT_REMOVE_TEMPLATE", e);
		}  				
	...
	*/
	private void deleteDataOfInstance(Connection con, String componentId, String suffixName) throws InstanciationException {
		...
		try {
		    ...
		    throw new InstanciationException("WhitePagesInstanciator.deleteDataOfInstance()", SilverpeasException.ERROR, "root.EX_SQL_QUERY_FAILED", se);
		}
		finally {
			try{
				stmt.close();
				...
				SilverTrace.error("whitePages", "WhitePagesInstanciator.deleteDataOfInstance()", "root.EX_RESOURCE_CLOSE_FAILED", "", err_closeStatement);
			}
		}
