...
/**
 * Le filtre LoginFilter a pour effet de contrôler que l'utilisateur courant n'a pas une
 * fiche à remplir dans une instance de whitePages. Si c'est le cas, 2 attributs
 * sont mis en sessions :
 * - RedirectToComponentId : componentId de l'instance pour que le mecanisme de redirection le renvoie sur le composant -
