...
public class InfoLetterStatistics implements ComponentStatisticsInterface
{
    ...
    public Vector getInfoLetters(String spaceId, String componentId) throws RemoteException
    {
        ...
        if ( listLettres != null )
        {
            ...
            for (int i = 0; i < listLettres.size(); i++)
            {
                ...
                listParutions = dataInterface.getInfoLetterPublications(defaultLetter.getPK());
