...
/**
 * List of components belonging to a specific suite
 * @author ahedin
 */
public class ComponentListVO {

  private String label;
  private String suiteIndex;
  private ArrayList<ComponentVO> components;

  public ComponentListVO(String label) {
    this.label = label;
    suiteIndex = "";
  ...
  public void setSuiteIndex(String suiteIndex) {
    this.suiteIndex = suiteIndex;
  }

  public String getSuiteIndex() {
    return suiteIndex;
  }
