...
public class PreviousHandler extends FunctionHandler {

  @Override
  public String getDestination(ClassifiedsSessionController classifiedsSC,
      HttpRequest request) throws Exception {

    ClassifiedDetail classified = classifiedsSC.getPrevious();
    request.setAttribute("ClassifiedId", classified.getId());
