...
public class HyperlinkInstanciator extends Object implements ComponentsInstanciatorIntf {
  ...
  {
	SilverTrace.info("hyperlink","HyperlinkInstanciator.create()","root.MSG_GEN_PARAM_VALUE","space = "+spaceId);
  }

  public void delete(Connection con, String spaceId, String componentId, String userId)
    throws InstanciationException 
  {
	SilverTrace.info("hyperlink","HyperlinkInstanciator.delete()","root.MSG_GEN_PARAM_VALUE","space = "+spaceId);
  }
}