...
public class HyperlinkSessionController extends AbstractComponentSessionController {
  ...
  public HyperlinkSessionController(MainSessionController mainSessionCtrl, ComponentContext context) { 
	super(mainSessionCtrl, context, "com.silverpeas.hyperlink.multilang.hyperlinkBundle", null,"com.silverpeas.hyperlink.settings.hyperlinkSettings");
  }
