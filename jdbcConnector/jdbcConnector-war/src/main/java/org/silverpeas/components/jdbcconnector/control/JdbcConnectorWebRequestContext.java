 ...
 * ConnecteurJDBC application that is targeted by the request.
 * @author mmoquillon
 */
public class JdbcConnectorWebRequestContext
    extends WebComponentRequestContext<JdbcConnectorWebController> {
}
