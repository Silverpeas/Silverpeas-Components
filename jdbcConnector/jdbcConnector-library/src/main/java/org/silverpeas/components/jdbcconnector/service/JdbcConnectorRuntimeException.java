 ...
 * nothing can be done to go back in a more stable state.
 */
public class JdbcConnectorRuntimeException extends SilverpeasRuntimeException {

  private static final long serialVersionUID = 9175773763045521699L;


  public JdbcConnectorRuntimeException(final String message) {
    super(message);
  }
