...
{ 
	...
	{ 
		...
		SilverTrace.info("processManager","ProcessManagerSessionController.constructor()", "root.MSG_GEN_PARAM_VALUE", "après getProcessModel()");
		...
		SilverTrace.info("processManager","ProcessManagerSessionController.constructor()", "root.MSG_GEN_PARAM_VALUE", "après resetCreationRights()");
   ...
   { 
	...
	/**
	 * L'historique peut être filtré. Dans ce cas, les formulaires associés à chaque état sont visibles uniquement si l'utilisateur
	 * courant était un working user ou un interested user.
	 */
