...
public class WebSitesRuntimeException extends SilverpeasRuntimeException {
  ...
  public WebSitesRuntimeException(String callingClass, int errorLevel, String message, String extraParams) {
	super(callingClass, errorLevel, message, extraParams);
  }

  public WebSitesRuntimeException(String callingClass, int errorLevel, String message, Exception nested) {
