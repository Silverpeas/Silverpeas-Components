...
public interface WebSiteBm extends EJBObject {
    ...
    public NodePK addFolder(NodeDetail subtopic, String alertType) throws RemoteException;
      
    public NodePK updateFolder(NodeDetail topic, String alertType) throws RemoteException;
    ...
    public void changeTopicsOrder(String way, NodePK nodePK, NodePK fatherPK) throws RemoteException;
    
    /* gestion des publi */
    public PublicationDetail getPublicationDetail(String pubId) throws RemoteException;

    public String createPublication(PublicationDetail pubDetail) throws RemoteException;
    
    //CBO : ADD
    public void addPublicationToTopic(String pubId, String fatherId) throws RemoteException;
    
    //CBO : ADD
    public void removePublicationToTopic(String pubId, String fatherId) throws RemoteException;
    ...
    //CBO : REMOVE public void updateInfoDetail(String pubId, InfoDetail infos) throws RemoteException;

    //CBO : UPDATE
    //public FolderDetail getPublicationFather(String pubId)  throws RemoteException;
    ...
    //CBO : ADD
    public void updateClassification(String pubId, ArrayList arrayTopic) throws RemoteException;
    public void changePubsOrder(String pubId, NodePK nodePK, int direction) throws RemoteException;
    //CbO : FIN ADD
    ...
    public void associateIcons(String id, Collection liste) throws RemoteException;   
    ...
    //CBO : REMOVE public void deleteWebSitesFromUpdate(Collection liste) throws RemoteException;
