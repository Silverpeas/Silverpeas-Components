...
public class SiteDetail extends PublicationDetail
{
       ...
       //CBO : REMOVE private String name; 
        ...
        private int type;				/* page interne creee (0) ou externe (1) ou page interne uploadee (2) */
        //CBO : REMOVE private String author;
        //CBO : REMOVE private String date;
        private int state;				/* site non publie (0) ou publie (1) */
		//CBO : REMOVE private String silverObjectId;	//added for the components - PDC integration
		//CBO : REMOVE private String iconUrl;			//added for the components - PDC integration
		private int popup = 1;
 ...
 */
 public SiteDetail(String idSite, String name, String description, String page, int type, String creatorId, String date, int state, int popup) {
     //CBO : ADD
	 super("X", name, description, null, null, null, creatorId, new Integer(type).toString(), idSite, "", page);
 ...
 */
 //CBO : UPDATE
 /*public void init(String idSite, String name, String description, String page, int type, String author, String date, int state, int popup){
...
*/
 public String toString() {
	 //CBO : UPDATE
	 //return sitePk+"|"+name+"|"+description+"|"+page+"|"+type+"|"+author+"|"+date+"|"+state;
	 return sitePk.getId()+"|"+this.getName()+"|"+this.getDescription()+"|"+this.getContent()+"|"+
	 		"|"+type+"|"+this.getCreatorId()+"|"+this.getCreationDate()+"|"+state;
 }
