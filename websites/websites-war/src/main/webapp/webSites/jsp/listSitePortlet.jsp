  ...
  <BODY leftmargin=5 topmargin=5>
    ...
    //Traitement = View, Search, Add, Update, Delete, Classify, Declassify
      ...
      if (action.equals("Search")) {
        ...
        tabbedPane.addTab(resources.getString("Organiser"), "javascript:goto_jsp('organize.jsp','')",
            false);
        tabbedPane.addTab(resources.getString("GML.management"), "javascript:goto_jsp('manage.jsp','')",
            false);
        ...
        while (i.hasNext()) {
          ...
          while (j.hasNext()) {
            ...
            Link l = new Link(subtheme.getName(),
                "javascript:goto_jsp('listSite.jsp?','Action=Search&Id=" + theme.getNodePK().getId()
                + "')");
          ...
          //Ajout d'une ligne
          navList.addItemSubItem(themeName, "javascript:goto_jsp('listSite.jsp?','Action=Search&Id="
              + themeId + "')", new Integer(nbPub).intValue(), listSubDirectory);
        }
