...
String url			= scc.getComponentUrl()+"pdcPositionsSite.jsp?Id="+id+"&Path="+URLEncoder.encode(path);
...
<%
	...
	tabbedPane.addTab(resources.getString("GML.description"), "design.jsp?Id="+id+"&Action=design&path="+URLEncoder.encode(path), false, true);
...
<FORM NAME="toComponent" ACTION="pdcPositionsSite.jsp" METHOD=POST >
