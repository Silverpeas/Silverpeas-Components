...
//Icons
  ...
  Button cancelButton = (Button) gef.getFormButton(resources.getString("GML.cancel"),
      "javascript:onClick=window.close();", false);
  Button validateButton = (Button) gef.getFormButton(resources.getString("GML.validate"),
...
<% } //End View
  ...
  SilverTrace.info("websites", "JSPaddPage", "root.MSG_GEN_PARAM_VALUE", "nomPage = " + name
      + " id=" + id);
%>
<HTML>
  <HEAD>
