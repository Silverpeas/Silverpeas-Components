 ...
 * <ul>
 *   <li>
 * RedirectToComponentId : componentId de l'instance pour que le mécanisme de redirection le
 * renvoie sur le composant</li>
 * <li>forceCardCreation : componentId de l'instance Le filtre RequestRouterFilter
 * vérifie la présence</li>
 * </ul>
 *
