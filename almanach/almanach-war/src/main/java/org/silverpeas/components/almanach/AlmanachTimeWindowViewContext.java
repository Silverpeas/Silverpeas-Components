 ...
 */
public class AlmanachTimeWindowViewContext extends CalendarTimeWindowViewContext {
   ...
   */
  AlmanachTimeWindowViewContext(final String componentInstanceId, final String locale, final
      ZoneId zoneId) {
