...
public class AlmanachInstanciator extends SQLRequest implements ComponentsInstanciatorIntf 
{
    ...
    {
		SilverTrace.info("almanach", "AlmanachInstanciator.create()", "almanach.MSG_CREATE_WITH_SPACE_AND_COMPONENT",
	...
	private void deleteDataOfInstance(Connection con, String componentId, String suffixName) throws InstanciationException {
		...
		try {
			...
			InstanciationException ie = new InstanciationException("AlmanachInstanciator.deleteDataOfInstance()", 
