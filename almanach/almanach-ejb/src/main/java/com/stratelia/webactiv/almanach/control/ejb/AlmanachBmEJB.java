...
public class AlmanachBmEJB implements AlmanachBmBusinessSkeleton, SessionBean {
    ...
    */
   public Collection getMonthEvents(EventPK pk, java.util.Date date, String[] instanceIds) {
		SilverTrace.info("almanach", "AlmanachBmEJB.getMonthsEvents()", "root.MSG_GEN_ENTER_METHOD");
		Connection con = null;
		try {
		  ...
		  throw new AlmanachRuntimeException("AlmanachBmEJB.getMonthEvents()", SilverpeasRuntimeException.ERROR, 
  ...
  /* (non-Javadoc)
 * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#getAllEvents(com.stratelia.webactiv.almanach.model.EventPK)
 */
   public Collection getAllEvents(EventPK pk) {
    ...
    try {
      ...
      throw new AlmanachRuntimeException("AlmanachBmEJB.getAllEvents()", SilverpeasRuntimeException.ERROR, 
		                                 "almanach.EXE_GET_ALL_EVENTS_FAIL", e);
    }
    finally {
      try{
        if (con != null)
   ...
   public Collection getAllEvents(EventPK pk, String[] instanceIds) {
    ...
    /* (non-Javadoc)
     * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#getEvents(java.util.Collection)
     */
    public Collection getEvents(Collection pks) {
        ...
        try {
          ...
          throw new AlmanachRuntimeException("AlmanachBmEJB.getEvents()", SilverpeasRuntimeException.ERROR,
                                             "almanach.EXE_GET_EVENTS_FAIL", e);
        }
        finally {
          try{
            if (con != null)
  ...
  public EventDetail getEventDetail(EventPK pk)
  {
    ...
    try {
      ...
      throw new AlmanachRuntimeException("AlmanachBmEJB.getEventDetail()", SilverpeasRuntimeException.ERROR, 
  ...
  /* (non-Javadoc)
 * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#addEvent(com.stratelia.webactiv.almanach.model.EventDetail)
 */
public String addEvent(EventDetail event) {
    ...
    try {
      ...
      throw new AlmanachRuntimeException("AlmanachBmEJB.addEvent()", SilverpeasRuntimeException.ERROR, 
  ...
  public void updateEvent(EventDetail event) 
  {
    ...
    try {
      ...
      throw new AlmanachRuntimeException("AlmanachBmEJB.updateEvent()", SilverpeasRuntimeException.ERROR, 
  ...
  public void removeEvent(EventPK pk){
    ...
    try {
      ...
      throw new AlmanachRuntimeException("AlmanachBmEJB.removeEvent()", SilverpeasRuntimeException.ERROR, 
		                                 "almanach.EXE_REMOVE_EVENT_FAIL", e);
    }
    finally {
      try{
        if (con != null) con.close();
  ...
  /* (non-Javadoc)
 * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#createIndex(com.stratelia.webactiv.almanach.model.EventDetail)
 */
  public void createIndex(EventDetail detail)  {
	SilverTrace.info("almanach", "AlmanachBmEJB.createIndex()", "root.MSG_GEN_ENTER_METHOD", "PK="+detail.getPK());
    try {
      FullIndexEntry indexEntry = null;
      if (detail != null) {
        indexEntry = new FullIndexEntry(detail.getPK().getComponentName(), "Event", detail.getPK().getId());
      ...
      SilverTrace.warn("almanach", "AlmanachBmEJB.createIndex()", "root.EXE_CREATE_INDEX_FAIL", null, e);
    }
  }
  	/**
  	 * Update Index Entry
  	 ...
  	 */
	private FullIndexEntry updateIndexEntryWithWysiwygContent(FullIndexEntry indexEntry, EventDetail eventDetail)
	{
		EventPK eventPK = eventDetail.getPK();
	    SilverTrace.info("almanach", "AlmanachBmEJB.updateIndexEntryWithWysiwygContent()", "root.MSG_GEN_ENTER_METHOD", "indexEntry = " + indexEntry.toString()+", eventPK = "+eventPK.toString());
		try
		{
			if (eventPK != null)
			{
				String wysiwygContent = WysiwygController.load(eventPK.getInstanceId(), eventPK.getId(), eventDetail.getLanguage());
				if (StringUtil.isDefined(wysiwygContent)) {
					String wysiwygPath = WysiwygController.getWysiwygPath(eventPK.getInstanceId(), eventPK.getId(), eventDetail.getLanguage());
 ...
 */
	private void deleteIndex(EventPK eventPK){
		SilverTrace.info("almanach", "AlmanachBmEJB.deleteIndex()", "almanach.MSG_GEN_ENTER_METHOD", "PK="+eventPK.toString());
	    IndexEntryPK indexEntry = new IndexEntryPK(eventPK.getComponentName(), "Event", eventPK.getId());
	    IndexEngineProxy.removeIndexEntry(indexEntry);
	  }

	  /* (non-Javadoc)
	 * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#getNextEvents(java.lang.String, int)
	 */
	public Collection getNextEvents(String instanceId, int nbReturned) {
	  SilverTrace.info("almanach", "AlmanachBmEJB.getNextEvents()", "root.MSG_GEN_ENTER_METHOD");
	    Connection con = null;
	    try {
	      ...
	      throw new AlmanachRuntimeException("AlmanachBmEJB.getNextEvents()", SilverpeasRuntimeException.ERROR, 
			                                 "almanach.EXE_GET_ALL_EVENTS_FAIL", e);
	    }
	    finally {
	      try{
	...
	private SilverpeasBeanDAO getEventPeriodicityDAO() {
		if (eventPeriodicityDAO == null) {
			try {
				eventPeriodicityDAO = SilverpeasBeanDAOFactory.getDAO("com.stratelia.webactiv.almanach.model.Periodicity");
	    	} catch (PersistenceException pe) {
				throw new AlmanachRuntimeException("AlmanachBmEJB.getEventPeriodicityDAO()",SilverpeasRuntimeException.ERROR,"almanach.EX_PERSISTENCE_PERIODICITY", pe);
			}
	    }
	...
	public void addPeriodicity(Periodicity periodicity) {
	    ...
	    try {
	    	...
	    	throw new AlmanachRuntimeException("AlmanachBmEJB.addPeriodicity()", SilverpeasRuntimeException.ERROR, 
			                                 "almanach.EX_ADD_PERIODICITY", e);
	    }
	  }
	...
	public Periodicity getPeriodicity(String eventId) {
	    ...
	    try {
	    	...
	    	throw new AlmanachRuntimeException("AlmanachBmEJB.getPeriodicity()", SilverpeasRuntimeException.ERROR, 
			                                 "almanach.EX_GET_PERIODICITY", e);
	    }
	  }
	...
	public void removePeriodicity(Periodicity periodicity)  {
	    ...
	    try {
	    	...
	    	throw new AlmanachRuntimeException("AlmanachBmEJB.removePeriodicity()", SilverpeasRuntimeException.ERROR, 
			                                 "almanach.EX_REMOVE_PERIODICITY", e);
	    }
	}
	...
	public void updatePeriodicity(Periodicity periodicity) {
	    ...
	    try {
	    	...
	    	throw new AlmanachRuntimeException("AlmanachBmEJB.updatePeriodicity()", SilverpeasRuntimeException.ERROR, 
			                                 "almanach.EX_UPDATE_PERIODICITY", e);
	    }
	  }
	...
	private SilverpeasBeanDAO getPeriodicityExceptionDAO() {
		if (periodicityExceptionDAO == null) {
			try {
				periodicityExceptionDAO = SilverpeasBeanDAOFactory.getDAO("com.stratelia.webactiv.almanach.model.PeriodicityException");
	    	} catch (PersistenceException pe) {
				throw new AlmanachRuntimeException("AlmanachBmEJB.getPeriodicityExceptionDAO()",SilverpeasRuntimeException.ERROR,"almanach.EX_PERSISTENCE_PERIODICITY_EXCEPTION", pe);
			}
	    }
	...
	/* (non-Javadoc)
	 * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#addPeriodicityException(com.stratelia.webactiv.almanach.model.PeriodicityException)
	 */
	public void addPeriodicityException(PeriodicityException periodicityException) {
		SilverTrace.info("almanach", "AlmanachBmEJB.addPeriodicityException()", "root.MSG_GEN_ENTER_METHOD");
	    ...
	    try {
	    	...
	    	throw new AlmanachRuntimeException("AlmanachBmEJB.addPeriodicityException()", SilverpeasRuntimeException.ERROR, 
	...
	public Collection getListPeriodicityException(String periodicityId) {
		SilverTrace.info("almanach", "AlmanachBmEJB.getListPeriodicityException()", "root.MSG_GEN_ENTER_METHOD");
	    try {
	    	IdPK pk = new IdPK();
	    	return getPeriodicityExceptionDAO().findByWhereClause(pk, "periodicityId = "+periodicityId);
	    }
	    catch(PersistenceException e){
	    	throw new AlmanachRuntimeException("AlmanachBmEJB.getListPeriodicityException()", SilverpeasRuntimeException.ERROR, 
	...
	public void removeAllPeriodicityException(String periodicityId) {
		SilverTrace.info("almanach", "AlmanachBmEJB.removeAllPeriodicityException()", "root.MSG_GEN_ENTER_METHOD");
	    ...
	    try {
	    	...
	    	throw new AlmanachRuntimeException("AlmanachBmEJB.removeAllPeriodicityException()", SilverpeasRuntimeException.ERROR, 
	...
	public Calendar getICal4jCalendar(Collection events, String language) {
		...
		while(itEvent.hasNext()) {
			...
			/*if(eventFatherId != null && eventFatherId.length()>0) {
				//Occurence spécifique d'un événement récurrent
				uid = new Uid(eventFatherId);
				recurrenceid = new RecurrenceId(new Date(calStartDate.getTime()));
				eventIcal4jCalendar.getProperties().add(recurrenceid);
			} else {*/
			uid = new Uid(eventId);
			/*}*/
			...
			if(periodicity != null) {
				...
				eventIcal4jCalendar.getProperties().add(generateExceptionDate(periodicity));
		    }
		...
		if(Recur.WEEKLY.equals(typeRecurence)) {
			...
			if(periodicity.getNumWeek() != 0) {//option choix du jour de la semaine
				if(periodicity.getDay() == java.util.Calendar.MONDAY) {
					recur.getDayList().add(new WeekDay(WeekDay.MO, periodicity.getNumWeek()));
				} else if(periodicity.getDay() == java.util.Calendar.TUESDAY) {//Tuesday
					recur.getDayList().add(new WeekDay(WeekDay.TU, periodicity.getNumWeek()));
				} else if(periodicity.getDay() == java.util.Calendar.WEDNESDAY) {
					recur.getDayList().add(new WeekDay(WeekDay.WE, periodicity.getNumWeek()));
				} else if(periodicity.getDay() == java.util.Calendar.THURSDAY) {
					recur.getDayList().add(new WeekDay(WeekDay.TH, periodicity.getNumWeek()));
				} else if(periodicity.getDay() == java.util.Calendar.FRIDAY) {
					recur.getDayList().add(new WeekDay(WeekDay.FR, periodicity.getNumWeek()));
				} else if(periodicity.getDay() == java.util.Calendar.SATURDAY) {
					recur.getDayList().add(new WeekDay(WeekDay.SA, periodicity.getNumWeek()));
				} else if(periodicity.getDay() == java.util.Calendar.SUNDAY) {
					recur.getDayList().add(new WeekDay(WeekDay.SU, periodicity.getNumWeek()));
				}
			}
		}
	...
	{
		//Exceptions de périodicité
		Collection listException = getListPeriodicityException(periodicity.getPK().getId());
		Iterator itException = (Iterator) listException.iterator();
		PeriodicityException periodicityException;
		DateList dateList = new DateList();
		java.util.Calendar calDateException = java.util.GregorianCalendar.getInstance();
		java.util.Calendar calDateFinException = java.util.GregorianCalendar.getInstance();
		while(itException.hasNext()) {
			...
			while(calDateException.before(calDateFinException) || calDateException.equals(calDateFinException)) {
	 ...
	 * @return
	 */
	public Collection getListRecurrentEvent(Calendar calendarAlmanach, java.util.Calendar currentDay, String spaceId, String instanceId) {
		SilverTrace.info("almanach", "AlmanachBmEJB.getListRecurrentEvent()", "root.MSG_GEN_ENTER_METHOD");
		...
		Period monthPeriod = new Period(new DateTime(firstDayMonth.getTime()), new DateTime(lastDayMonth.getTime()));
		...
		while(itVEvent.hasNext()) {
			...
			idEvent = eventIcal4jCalendar.getProperties().getProperty(Property.UID).getValue();
			...
			while(itPeriod.hasNext()) {
				...
				copy = new EventDetail(evtDetail.getNameDescription(), evtDetail.getPK(), evtDetail.getPriority(), evtDetail.getTitle(), evtDetail.getStartHour(), evtDetail.getEndHour(), evtDetail.getPlace(), evtDetail.getEventUrl());

				copy.setStartDate(new java.util.Date(recurrencePeriod.getStart().getTime()));
				copy.setEndDate(new java.util.Date(recurrencePeriod.getEnd().getTime()));
       ...
       /*****************************************************************************************************************/
		...
		/* (non-Javadoc)
		 * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#getSilverObjectId(com.stratelia.webactiv.almanach.model.EventPK)
		 */
		public int getSilverObjectId(EventPK eventPK) {
			SilverTrace.info("almanach","AlmanachBmEJB.getSilverObjectId()", "root.MSG_GEN_ENTER_METHOD", "eventPK = "+eventPK.toString());
			int			silverObjectId	= -1;
			EventDetail detail			= null;
			try {
				silverObjectId	= getAlmanachContentManager().getSilverObjectId(eventPK.getId(), eventPK.getComponentName());
				if (silverObjectId == -1) {
					detail			= getEventDetail(eventPK);
					silverObjectId	= createSilverContent(null, detail, detail.getDelegatorId());
				}
			} catch (Exception e) {
				throw new AlmanachRuntimeException("AlmanachBmEJB.getSilverObjectId()",SilverpeasRuntimeException.ERROR,"almanach.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
			}
        ...
        private int createSilverContent(Connection con, EventDetail eventDetail, String creatorId) {
            SilverTrace.info("Almanach","AlmanachBmEJB.createSilverContent()", "root.MSG_GEN_ENTER_METHOD", "eventId = "+eventDetail.getPK().getId());
            try {
                return getAlmanachContentManager().createSilverContent(con, eventDetail, creatorId);
            } catch (Exception e) {
                throw new AlmanachRuntimeException("AlmanachBmEJB.createSilverContent()",SilverpeasRuntimeException.ERROR,"almanach.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
            }
        }
        ...
        private void deleteSilverContent(Connection con, EventPK eventPK) {
            SilverTrace.info("almanach","AlmanachBmEJB.deleteSilverContent()", "root.MSG_GEN_ENTER_METHOD", "eventId = "+eventPK.getId());
            try
            {
                getAlmanachContentManager().deleteSilverContent(con, eventPK);
            } catch (Exception e) {
                throw new AlmanachRuntimeException("AlmanachBmEJB.deleteSilverContent()",SilverpeasRuntimeException.ERROR,"almanach.EX_IMPOSSIBLE_DOBTENIR_LE_SILVEROBJECTID", e);
            }
        }
    	...
    	/* (non-Javadoc)
    	 * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#getAttachments(com.stratelia.webactiv.almanach.model.EventPK)
    	 */
    	public Collection getAttachments(EventPK eventPK) {
    		SilverTrace.info("almanach", "AlmanachBmEJB.getAttachments()", "root.MSG_GEN_ENTER_METHOD", "eventId = "+eventPK.getId());
    		String ctx = "Images";
    		AttachmentPK foreignKey =  new AttachmentPK(eventPK.getId(), null, eventPK.getComponentName());
    		SilverTrace.info("almanach", "AlmanachBmEJB.getAttachments()", "root.MSG_GEN_PARAM_VALUE", "foreignKey = " + foreignKey.toString());
    		...
    		try
    		{
    			...
    			SilverTrace.info("almanach", "AlmanachBmEJB.getAttachments()", "root.MSG_GEN_PARAM_VALUE", "attachmentList.size() = " + attachmentList.size());
    			return attachmentList;	
    		}
    		catch (Exception e)
    		{
    			throw new AlmanachRuntimeException("AlmanachBmEJB.getAttachments()", SilverpeasRuntimeException.ERROR, "almanach.EX_IMPOSSIBLE_DOBTENIR_LES_FICHIERSJOINTS", e);
    		}
    	}
    	...
    	private Connection getConnection() {
            ...
            {
                throw new AlmanachRuntimeException("AlmanachBmEJB.getConnection()", SilverpeasRuntimeException.ERROR, "root.EX_CONNECTION_OPEN_FAILED", e);
            }
        }
    	
    	/* (non-Javadoc)
    	 * @see com.stratelia.webactiv.almanach.control.ejb.AlmanachBmBusinessSkeleton#getHTMLPath(com.stratelia.webactiv.almanach.model.EventPK)
    	 */
    	public String getHTMLPath(EventPK eventPK)
    	{
    		...
    		try 
    		{
    			htmlPath = getSpacesPath(eventPK.getInstanceId()) + getComponentLabel(eventPK.getInstanceId()) ;
    		} 
    		catch (Exception e) {
    			throw new AlmanachRuntimeException("AlmanachBmEJB.getHTMLPath()",SilverpeasRuntimeException.ERROR,"gallery.EX_IMPOSSIBLE_DOBTENIR_LES_EMPLACEMENTS_DE_LA_PUBLICATION", e);
    		}
    		return htmlPath;
    	}
  ...
  {
	SilverTrace.info("almanach", "AlmanachBmEJB.ejbCreate()", "root.MSG_GEN_ENTER_METHOD");
  }

  public void ejbRemove() throws javax.ejb.EJBException, java.rmi.RemoteException
  {
    SilverTrace.info("almanach", "AlmanachBmEJB.ejbRemove()", "root.MSG_GEN_ENTER_METHOD");
  }

  public void ejbActivate() throws javax.ejb.EJBException, java.rmi.RemoteException
  {
    SilverTrace.info("almanach", "AlmanachBmEJB.ejbActivate()", "root.MSG_GEN_ENTER_METHOD");
  }
  public void ejbPassivate() throws javax.ejb.EJBException, java.rmi.RemoteException
  {
    SilverTrace.info("almanach", "AlmanachBmEJB.ejbPassivate()", "root.MSG_GEN_ENTER_METHOD");
  }

  public void setSessionContext(final javax.ejb.SessionContext p1) throws javax.ejb.EJBException, java.rmi.RemoteException
  {
    SilverTrace.info("almanach", "AlmanachBmEJB.setSessionContext()", "root.MSG_GEN_ENTER_METHOD");
  }
