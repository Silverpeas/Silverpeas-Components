        ...
        try
        {
            if (answers != null)
            {
                ...
                while (itA.hasNext())
                {
                    ...
                    {
                    	// l'enqu√™te n'est pas anonyme et le % de r√©ponse n'est pas nulle : afficher l'icone pour visualiser les users
        ...
        try
        {
            if (answers != null)
            {
                ...
                while (itA.hasNext())
                {
                	rang = rang + 1;
                    Answer answer = (Answer) itA.next();
                 	// affichage de la ligne des differentes rÈponses possibles
                    if (answer.isOpened() &&
                ...
                while (itU.hasNext())
                {
                	...
                	if (!saveUser.equals(userName))
                	{
	                	...
	                	// rechercher les r√©ponses pour cet utilisateur
	                	String value;
	                	...
	                	while (it.hasNext())
	                	{
	                		...
	                		// d√©caller pour se trouver dans la bonne colonne
	                	...
	                	// completer la ligne avec des cases √† "vide"
		              	while (position <= rang)
		              	{
		              		r += "<td class=\"questionResults-Non\">&nbsp;</td>";
		              		position = position + 1;
            ...
            if (answers != null)
            {
                ...
                while (itA.hasNext())
                {
                    ...
                    else
                    {
                 	...
                 	// mettre en valeur cette rÈponse si c'est le choix de l'utilisateur
                    if (resultsByUser.contains(answer.getPK().getId())) {
