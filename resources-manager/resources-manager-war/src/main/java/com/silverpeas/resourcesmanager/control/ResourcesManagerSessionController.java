...
public class ResourcesManagerSessionController extends AbstractComponentSessionController
{
     ...
     * @see
     */
	public ResourcesManagerSessionController(MainSessionController mainSessionCtrl, ComponentContext componentContext)
	{
		super(mainSessionCtrl, componentContext,  "com.silverpeas.resourcesmanager.multilang.resourcesManagerBundle", "com.silverpeas.resourcesmanager.settings.resourcesManagerIcons");
	}
	...
	public void createCategory(CategoryDetail category)
	{
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.createCategory()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public void updateCategory(CategoryDetail category)
	{
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.updateCategory()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	...
	public List getCategories()
	{
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getCategories()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public CategoryDetail getCategory(String id)
	{
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getCategory()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}	
	}
	...
	{	
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.deleteCategory()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public String createResource(ResourceDetail resource)
	{
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.createResource()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public void updateResource(ResourceDetail resource)
	{
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.updateResource()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public ResourceDetail getResource(String id)
	{
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getResource()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}	
	}
	...
	{	
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.deleteResource()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public List getResourcesByCategory(String categoryId)
	{
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getResourcesByCategory()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public List getResourcesReservable(Date startDate, Date endDate)
	{
		...
		try
		{
			listeResources = getResourcesManagerBm().getResourcesReservable(getComponentId(),startDate,endDate);
			this.listReservableResource = listeResources;			
			return listReservableResource;
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getResourcesReservable()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	{		
		try
		{ 
			return getResourcesManagerBm().getResourcesofReservation(getComponentId(),reservationId);
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getResourcesofReservation()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public void saveReservation()
	{
		try
		{
			getResourcesManagerBm().saveReservation(reservationCourante, listReservationCurrent);
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.saveReservation()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	{		
		try
		{ 
			return getResourcesManagerBm().verificationReservation(getComponentId(),listeReservation,beginDateReservation,endDateReservation);
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.verificationReservation()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	
	public List getResourcesProblemDate(String listeReservation,Date beginDate, Date endDate,String reservationId)
	{		
		try
		{ 
			return getResourcesManagerBm().verificationNewDateReservation(getComponentId(),listeReservation,beginDate,endDate,reservationId);
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getResourcesProblemDate()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	{		
		...
		{ 
			...
			List list = getResourcesManagerBm().getReservationUser(idComponent,idUser);
			return list;
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getReservationUser()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public void updateReservation(String idModifiedReservation,String listReservation)
	{		
		try
		{ 
			reservationCourante.setId(idModifiedReservation);
			getResourcesManagerBm().updateReservation(listReservation,reservationCourante);
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.updateReservation()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	{	
		try
		{
			...
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.deleteReservation()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	private ResourcesManagerBm getResourcesManagerBm()
	{
		...
		try
		{
			ResourcesManagerBmHome resourcesmanagerBmHome = (ResourcesManagerBmHome) EJBUtilitaire.getEJBObjectRef("ejb/ResourcesManagerBm", ResourcesManagerBmHome.class);
			resourcesmanagerBm = resourcesmanagerBmHome.create();
		}
		catch (Exception e)
		{
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getResourcesManageryBm()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
...
//	AJOUT : pour traiter l'affichage des semaines sur 5 ou 7 jours
	...
	{		
		try
		{ 	
			return getResourcesManagerBm().getMonthReservation(getComponentId(), getCurrentDay().getTime(), getUserId(), getLanguage());
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getMonthReservation()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	{		
		try
		{ 						
			return getResourcesManagerBm().getMonthReservation(getComponentId(), this.getCurrentDay().getTime(), idUser, this.getLanguage());
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getMonthReservation()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	...
	{		
		try
		{
			return getResourcesManagerBm().getMonthReservationOfCategory(getComponentId(), getCurrentDay().getTime(), getUserId(), getLanguage(),idCategory);
		}
		catch (RemoteException e) {
			throw new ResourcesManagerRuntimeException("ResourcesManagerSessionController.getMonthReservationOfCategory()", SilverpeasRuntimeException.ERROR, "root.EX_CANT_GET_REMOTE_OBJECT", e);
		}
	}
	...
	public String initUPToSelectValidator(String pubId)
	{
		...
		hostPath[0] = new PairObject(getString("resourcesManagerSC.SelectValidator"), "");
	...
	{
		String m_context = GeneralPropertiesManager.getGeneralResourceLocator().getString("ApplicationURL");	
		PairObject hostComponentName = new PairObject(getString("resourcesManager.accueil"), m_context + "/RresourcesManager/jsp/Main");
		PairObject[] hostPath = new PairObject[1];
		hostPath[0] = new PairObject(getString("resourcesManager.otherPlanning"), m_context + URLManager.getURL(null, getComponentId()) + "Main");
		String hostUrl = m_context + URLManager.getURL(null, getComponentId()) + "ViewOtherPlanning";
		String cancelUrl = m_context + URLManager.getURL(null, getComponentId()) + "Main";
		Selection sel = getSelection();
		sel.resetAll();
