...
public class ResourcesManagerInstancePreDestructionIntegrationTest {
  ...
  public static Archive<?> createTestArchive() {
    return BasicWarBuilder.onWarForTestClass(
        ResourcesManagerInstancePreDestructionIntegrationTest.class).testFocusedOn(warBuilder -> {
