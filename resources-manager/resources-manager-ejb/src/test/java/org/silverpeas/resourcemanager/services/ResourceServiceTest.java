...
public class ResourceServiceTest {
  ...
  private static Category firstCategory = new Category("1", "resourcesManager42", "Salles",
      new Date(1315232752398L), new Date(1315232752398L), true, "model1.xml", "5", "5", "5",
      "Salles de réunion");
  private static Category secondCategory = new Category("2", "resourcesManager42", "Voitures",
      new Date(1315232752398L), new Date(1315232752398L), true, null, "6", "6", "6",
  ...
  public void testUpdateResource() {
    ...
    Resource resource = new Resource("1", firstCategory, "Salle Chartreuse",
        new Date(1315232852398L), new Date(1315232852398L), "Salle de réunion jusqu'à 4 personnes",
        "5", "5", "5", "resourcesManager42", true);
  ...
  public void testDeleteResourcesFromCategory() {
    ...
    assertThat(result, contains(new Resource("1", firstCategory, "Salle Chartreuse",
        ...
        1315232852398L), "Salle de réunion jusqu'à 12 personnes", "5", "5", "5",
        "resourcesManager42", true)));
